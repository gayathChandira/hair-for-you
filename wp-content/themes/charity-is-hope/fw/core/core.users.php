...
if (!function_exists('charity_is_hope_add_fields_in_user_profile')) {
	...
	?>
		<h3><?php esc_html_e('User Position', 'charity-is-hope'); ?></h3>
		<table class="form-table">
			<tr>
				<th><label for="user_position"><?php esc_html_e('User position', 'charity-is-hope'); ?>:</label></th>
				<td><input type="text" name="user_position" id="user_position" size="55" value="<?php echo esc_attr(get_the_author_meta('user_position', $user->ID)); ?>" />
					<span class="description"><?php esc_html_e('Please, enter your position in the company', 'charity-is-hope'); ?></span>
				</td>
			</tr>
		</table>
	
		<h3><?php esc_html_e('Social links', 'charity-is-hope'); ?></h3>
		<table class="form-table">
		<?php
				...
				if (!empty($sn)) {
					...
					<tr>
						...
						<td><input type="text" name="user_<?php echo esc_attr($sn); ?>" id="user_<?php echo esc_attr($sn); ?>" size="55" value="<?php echo esc_attr(get_the_author_meta('user_'.($sn), $user->ID)); ?>" />
							<span class="description"><?php echo sprintf(esc_html__('Please, enter your %s link', 'charity-is-hope'), charity_is_hope_strtoproper($sn)); ?></span>
						</td>
					</tr>
					<?php
				}
