...
if ( !function_exists( 'charity_is_hope_core_customizer_theme_setup' ) ) {
	...
	function charity_is_hope_core_customizer_theme_setup() {
		...
		if ( is_admin() ) {
			...
			add_action('wp_ajax_nopriv_charity_is_hope_options_save',			'charity_is_hope_core_customizer_save_options');
			...
			add_action('wp_ajax_nopriv_charity_is_hope_options_scheme_delete',	'charity_is_hope_core_customizer_scheme_delete');
			...
			add_action('wp_ajax_nopriv_charity_is_hope_options_scheme_copy',	'charity_is_hope_core_customizer_scheme_copy');
		}
...
if (!function_exists('charity_is_hope_core_customizer_load_scripts')) {
	function charity_is_hope_core_customizer_load_scripts() {
		if (file_exists(charity_is_hope_get_file_dir('core/core.customizer/core.customizer.css')))
			wp_enqueue_style( 'charity_is_hope-core-customizer-style',	charity_is_hope_get_file_url('core/core.customizer/core.customizer.css'), array(), null);
		if (file_exists(charity_is_hope_get_file_dir('core/core.customizer/core.customizer.js')))
			wp_enqueue_script( 'charity_is_hope-core-customizer-script', charity_is_hope_get_file_url('core/core.customizer/core.customizer.js'), array(), null );
	}
}
