...
if ( !function_exists( 'charity_is_hope_customizer_wp_control_js' ) ) {
	...
	function charity_is_hope_customizer_wp_control_js() {
		wp_enqueue_style( 'charity_is_hope-customizer-wp', charity_is_hope_get_file_url('core/core.customizer.wp/core.customizer.wp.css') );
		wp_enqueue_script( 'charity_is_hope-core-utils-script', charity_is_hope_get_file_url('js/core.utils.js'), array(), null, true );
		wp_enqueue_script( 'charity_is_hope-customizer-wp-color-scheme-control', charity_is_hope_get_file_url('core/core.customizer.wp/core.customizer.wp.color-scheme.js'), array( 'customize-controls', 'iris', 'underscore', 'wp-util' ) );
		wp_localize_script( 'charity_is_hope-customizer-wp-color-scheme-control', 'charity_is_hope_color_schemes', charity_is_hope_storage_get('custom_colors') );
		wp_localize_script( 'charity_is_hope-customizer-wp-color-scheme-control', 'charity_is_hope_fonts', charity_is_hope_storage_get('custom_fonts') );
		wp_localize_script( 'charity_is_hope-customizer-wp-color-scheme-control', 'charity_is_hope_dependencies', charity_is_hope_storage_get('customizer_depends') );
		wp_localize_script( 'charity_is_hope-customizer-wp-color-scheme-control', 'charity_is_hope_customizer_vars', array(
...
if ( !function_exists( 'charity_is_hope_customizer_wp_preview_js' ) ) {
	...
	function charity_is_hope_customizer_wp_preview_js() {
		wp_enqueue_script( 'charity_is_hope-customizer-wp-preview', charity_is_hope_get_file_url('core/core.customizer.wp/core.customizer.wp.preview.js'), array( 'customize-preview' ) );
		wp_localize_script( 'charity_is_hope-customizer-wp-preview', 'charity_is_hope_previewer_vars', array(
			'need_refresh' => charity_is_hope_get_theme_setting('less_compiler')!='no',
