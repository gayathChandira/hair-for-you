...
if (!function_exists('charity_is_hope_post_add_options_column')) {
	//add_filter('manage_edit-{post_type}_columns',	'charity_is_hope_post_add_options_column', 9);
...
if (!function_exists('charity_is_hope_post_fill_options_column')) {
	//add_filter('manage_{post_type}_custom_column',	'charity_is_hope_post_fill_options_column', 9, 2);
...
if ( !function_exists( 'charity_is_hope_post_get_blog_title' ) ) {
	...
	function charity_is_hope_post_get_blog_title($title, $page) {
		...
		if (is_front_page())
			...
			$title = sprintf( esc_html__( '%s', 'charity-is-hope' ), single_cat_title( '', false ) );
		else if ( $page == 'tag' )
