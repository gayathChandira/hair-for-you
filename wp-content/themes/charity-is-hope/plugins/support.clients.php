...
if (!function_exists('charity_is_hope_clients_after_theme_setup')) {
	...
	function charity_is_hope_clients_after_theme_setup() {
		...
		if (charity_is_hope_storage_get_array('post_override_options', 'page')=='clients') {
			// Meta box fields
			charity_is_hope_storage_set_array('post_override_options', 'title', esc_html__('Client Options', 'charity-is-hope'));
			charity_is_hope_storage_set_array('post_override_options', 'fields', array(
				"mb_partition_clients" => array(
					"title" => esc_html__('Clients', 'charity-is-hope'),
					"override" => "page,post,custom",
					"divider" => false,
					"icon" => "iconadmin-users",
					"type" => "partition"),
				"mb_info_clients_1" => array(
					"title" => esc_html__('Client details', 'charity-is-hope'),
					"override" => "page,post,custom",
					"divider" => false,
					"desc" => wp_kses_data( __('In this section you can put details for this client', 'charity-is-hope') ),
					"class" => "client_meta",
					"type" => "info"),
				"client_name" => array(
					"title" => esc_html__('Contact name',  'charity-is-hope'),
					"desc" => wp_kses_data( __("Name of the contacts manager", 'charity-is-hope') ),
					"override" => "page,post,custom",
					"class" => "client_name",
					"std" => '',
					"type" => "text"),
				"client_position" => array(
					...
					"desc" => wp_kses_data( __("Position of the contacts manager", 'charity-is-hope') ),
					"override" => "page,post,custom",
					"class" => "client_position",
					"std" => '',
					"type" => "text"),
				"client_show_link" => array(
					"title" => esc_html__('Show link',  'charity-is-hope'),
					"desc" => wp_kses_data( __("Show link to client page", 'charity-is-hope') ),
					"override" => "page,post,custom",
				...
				"client_link" => array(
					...
					"desc" => wp_kses_data( __("URL of the client's site. If empty - use link to this page", 'charity-is-hope') ),
					"override" => "page,post,custom",
					"class" => "client_link",
					"std" => '',
					"type" => "text")
	...
	function charity_is_hope_clients_get_blog_title($title, $page) {
		...
		if ( charity_is_hope_strpos($page, 'clients')!==false ) {
			if ( $page == 'clients_category' ) {
				...
				$title = esc_html__('All clients', 'charity-is-hope');
			}
		}
		return $title;
	}
...
if (!function_exists('charity_is_hope_clients_reg_shortcodes')) {
	//add_filter('charity_is_hope_action_shortcodes_list',	'charity_is_hope_clients_reg_shortcodes');
	function charity_is_hope_clients_reg_shortcodes() {
		if (charity_is_hope_storage_isset('shortcodes')) {
			...
			charity_is_hope_sc_map_after('trx_chat', array(
				...
				"trx_clients" => array(
					"title" => esc_html__("Clients", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Insert clients list in your page (post)", 'charity-is-hope') ),
					"decorate" => true,
					"container" => false,
					"params" => array(
						"title" => array(
						...
						"style" => array(
							"title" => esc_html__("Clients style", 'charity-is-hope'),
							"desc" => wp_kses_data( __("Select style to display clients list", 'charity-is-hope') ),
							"value" => "clients-1",
							"type" => "select",
						...
						"columns" => array(
							...
							"desc" => wp_kses_data( __("How many columns use to show clients", 'charity-is-hope') ),
							"value" => 4,
							"min" => 2,
							"max" => 6,
							"step" => 1,
						...
						"slider" => array(
							...
							"desc" => wp_kses_data( __("Use slider to show clients", 'charity-is-hope') ),
							"value" => "no",
							"type" => "switch",
						...
						"cat" => array(
							...
							"style" => "list",
							"multiple" => true,
							"options" => charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $clients_groups)
						),
						"count" => array(
					...
					"children" => array(
						...
						"title" => esc_html__("Client", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Single client (custom parameters)", 'charity-is-hope') ),
						"container" => true,
						"params" => array(
							"name" => array(
								"title" => esc_html__("Name", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Client's name", 'charity-is-hope') ),
								"divider" => true,
								"value" => "",
								"type" => "text"
							),
							"position" => array(
								"title" => esc_html__("Position", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Client's position", 'charity-is-hope') ),
								"value" => "",
								"type" => "text"
							),
							"link" => array(
								"title" => esc_html__("Link", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Link on client's personal page", 'charity-is-hope') ),
								"divider" => true,
								"value" => "",
								"type" => "text"
							),
							"image" => array(
								...
								"desc" => wp_kses_data( __("Client's image", 'charity-is-hope') ),
								"value" => "",
								"readonly" => false,
								"type" => "media"
							),
							"_content_" => array(
								"title" => esc_html__("Description", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Client's short description", 'charity-is-hope') ),
								"divider" => true,
								"rows" => 4,
								"value" => "",
								"type" => "textarea"
...
if (!function_exists('charity_is_hope_clients_reg_shortcodes_vc')) {
	//add_filter('charity_is_hope_action_shortcodes_list_vc',	'charity_is_hope_clients_reg_shortcodes_vc');
	function charity_is_hope_clients_reg_shortcodes_vc() {
		...
		vc_map( array(
				"base" => "trx_clients",
				"name" => esc_html__("Clients", 'charity-is-hope'),
				"description" => wp_kses_data( __("Insert clients list", 'charity-is-hope') ),
				...
				"params" => array(
					array(
						"param_name" => "style",
						"heading" => esc_html__("Clients style", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select style to display clients list", 'charity-is-hope') ),
						"class" => "",
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses_data( __("Allow get clients from inner shortcodes (custom) or get it from specified group (cat)", 'charity-is-hope') ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Select category to show clients. If empty - select clients from any category (group) or from IDs list", 'charity-is-hope') ),
						...
						"class" => "",
						"value" => array_flip(charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $clients_groups)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "columns",
						"heading" => esc_html__("Columns", 'charity-is-hope'),
						"description" => wp_kses_data( __("How many columns use to show clients", 'charity-is-hope') ),
						"group" => esc_html__('Query', 'charity-is-hope'),
						"admin_label" => true,
						"class" => "",
						"value" => "4",
					...
					array(
						...
						"description" => wp_kses_data( __("Comma separated list of client's ID. If set - parameters above (category, count, order, etc.)  are ignored!", 'charity-is-hope') ),
						"group" => esc_html__('Query', 'charity-is-hope'),
						'dependency' => array(
							'element' => 'custom',
							'is_empty' => true
		...
		vc_map( array(
				...
				"name" => esc_html__("Client", 'charity-is-hope'),
				"description" => wp_kses_data( __("Client - all data pull out from it account on your site", 'charity-is-hope') ),
				"show_settings_on_create" => true,
				...
				"params" => array(
					array(
						...
						"description" => wp_kses_data( __("Client's name", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => wp_kses_data( __("Client's position", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => wp_kses_data( __("Link on client's personal page", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "image",
						"heading" => esc_html__("Client's image", 'charity-is-hope'),
						"description" => wp_kses_data( __("Clients's image", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
