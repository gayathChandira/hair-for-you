...
if (!function_exists('charity_is_hope_team_theme_setup')) {
	...
	function charity_is_hope_team_theme_setup() {
		...
		charity_is_hope_storage_set('team_override_options', array(
			'id' => 'team-meta-box',
			'title' => esc_html__('Team Member Details', 'charity-is-hope'),
			'page' => 'team',
			'context' => 'normal',
			'priority' => 'high',
			'fields' => array(
				"team_member_position" => array(
					...
					"desc" => wp_kses_data( __("Position of the team member", 'charity-is-hope') ),
					"class" => "team_member_position",
					"std" => "",
					"type" => "text"),
				"team_member_bday" => array(
					"title" => esc_html__("Birthday",  'charity-is-hope'),
					"desc" => wp_kses_data( __("Birthday of the team member", 'charity-is-hope') ),
					"class" => "team_member_email",
					"std" => "",
					"type" => "text"),
				"team_member_email" => array(
					"title" => esc_html__("E-mail",  'charity-is-hope'),
					"desc" => wp_kses_data( __("E-mail of the team member - need to take Gravatar (if registered)", 'charity-is-hope') ),
					"class" => "team_member_email",
					"std" => "",
					"type" => "text"),
				"team_member_link" => array(
					"title" => esc_html__('Link to profile',  'charity-is-hope'),
					"desc" => wp_kses_data( __("URL of the team member profile page (if not this page)", 'charity-is-hope') ),
					"class" => "team_member_link",
					"std" => "",
					"type" => "text"),
				"team_member_socials" => array(
					"title" => esc_html__("Social links",  'charity-is-hope'),
					"desc" => wp_kses_data( __("Links to the social profiles of the team member", 'charity-is-hope') ),
					"class" => "team_member_email",
					"std" => "",
					"type" => "social"),
				"team_member_brief_info" => array(
					"title" => esc_html__("Brief info",  'charity-is-hope'),
					"desc" => wp_kses_data( __("Brief info about the team member", 'charity-is-hope') ),
	...
	function charity_is_hope_team_get_blog_title($title, $page) {
		...
		if ( charity_is_hope_strpos($page, 'team')!==false ) {
			if ( $page == 'team_category' ) {
				...
				$title = esc_html__('All team', 'charity-is-hope');
			}
		}
...
if (!function_exists('charity_is_hope_team_reg_shortcodes')) {
	//add_filter('charity_is_hope_action_shortcodes_list',	'charity_is_hope_team_reg_shortcodes');
	function charity_is_hope_team_reg_shortcodes() {
		if (charity_is_hope_storage_isset('shortcodes')) {
			...
			charity_is_hope_sc_map_after('trx_tabs', array(
				...
				// Team
				"trx_team" => array(
					"title" => esc_html__("Team", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Insert team in your page (post)", 'charity-is-hope') ),
					"decorate" => true,
					"container" => false,
					"params" => array(
						"title" => array(
						...
						"style" => array(
							"title" => esc_html__("Team style", 'charity-is-hope'),
							"desc" => wp_kses_data( __("Select style to display team members", 'charity-is-hope') ),
							"value" => "team-1",
							"type" => "select",
							"options" => $team_styles
						),
						"columns" => array(
							...
							"desc" => wp_kses_data( __("How many columns use to show team members", 'charity-is-hope') ),
							"value" => 3,
							"min" => 2,
							"max" => 5,
							"step" => 1,
						...
						"slider" => array(
							...
							"desc" => wp_kses_data( __("Use slider to show team members", 'charity-is-hope') ),
							"value" => "no",
							"type" => "switch",
						...
						"controls" => array(
							...
							"desc" => wp_kses_data( __("Slider controls style and position", 'charity-is-hope') ),
							"dependency" => array(
								'slider' => array('yes')
							),
							"divider" => true,
						...
						"align" => array(
							...
							"desc" => wp_kses_data( __("Alignment of the team block", 'charity-is-hope') ),
							"divider" => true,
							"value" => "",
							"type" => "checklist",
							"dir" => "horizontal",
						...
						"custom" => array(
							"title" => esc_html__("Custom", 'charity-is-hope'),
							"desc" => wp_kses_data( __("Allow get team members from inner shortcodes (custom) or get it from specified group (cat)", 'charity-is-hope') ),
							"divider" => true,
							"value" => "no",
							"type" => "switch",
							"options" => charity_is_hope_get_sc_param('yes_no')
						...
						"cat" => array(
							...
							"desc" => wp_kses_data( __("Select categories (groups) to show team members. If empty - select team members from any category (group) or from IDs list", 'charity-is-hope') ),
							"dependency" => array(
								'custom' => array('no')
							),
							"divider" => true,
							...
							"style" => "list",
							"multiple" => true,
							"options" => charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $team_groups)
						),
						"count" => array(
					...
					"children" => array(
						"name" => "trx_team_item",
						"title" => esc_html__("Member", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Team member", 'charity-is-hope') ),
						"container" => true,
						"params" => array(
							"user" => array(
								"title" => esc_html__("Registerd user", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Select one of registered users (if present) or put name, position, etc. in fields below", 'charity-is-hope') ),
								"value" => "",
								"type" => "select",
								"options" => $users
							),
							"member" => array(
								"title" => esc_html__("Team member", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Select one of team members (if present) or put name, position, etc. in fields below", 'charity-is-hope') ),
								"value" => "",
								"type" => "select",
								"options" => $members
							),
							"link" => array(
								...
								"desc" => wp_kses_data( __("Link on team member's personal page", 'charity-is-hope') ),
								"divider" => true,
								"value" => "",
								"type" => "text"
							),
							"name" => array(
								"title" => esc_html__("Name", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Team member's name", 'charity-is-hope') ),
								"divider" => true,
								"dependency" => array(
							...
							"position" => array(
								"title" => esc_html__("Position", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Team member's position", 'charity-is-hope') ),
								"dependency" => array(
									'user' => array('is_empty', 'none'),
									'member' => array('is_empty', 'none')
								),
							...
							"email" => array(
								"title" => esc_html__("E-mail", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Team member's e-mail", 'charity-is-hope') ),
								"dependency" => array(
									'user' => array('is_empty', 'none'),
									'member' => array('is_empty', 'none')
								),
							...
							"photo" => array(
								"title" => esc_html__("Photo", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Team member's photo (avatar)", 'charity-is-hope') ),
								"dependency" => array(
									'user' => array('is_empty', 'none'),
									'member' => array('is_empty', 'none')
								),
							...
							"socials" => array(
								...
								"desc" => wp_kses_data( __("Team member's socials icons: name=url|name=url... For example: facebook=http://facebook.com/myaccount|twitter=http://twitter.com/myaccount", 'charity-is-hope') ),
								"dependency" => array(
									'user' => array('is_empty', 'none'),
									'member' => array('is_empty', 'none')
								),
							...
							"_content_" => array(
								"title" => esc_html__("Description", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Team member's short description", 'charity-is-hope') ),
								"divider" => true,
								"rows" => 4,
								"value" => "",
								"type" => "textarea"
...
if (!function_exists('charity_is_hope_team_reg_shortcodes_vc')) {
	//add_filter('charity_is_hope_action_shortcodes_list_vc',	'charity_is_hope_team_reg_shortcodes_vc');
	function charity_is_hope_team_reg_shortcodes_vc() {
		...
		vc_map( array(
				"base" => "trx_team",
				"name" => esc_html__("Team", 'charity-is-hope'),
				"description" => wp_kses_data( __("Insert team members", 'charity-is-hope') ),
				...
				"params" => array(
					array(
						"param_name" => "style",
						"heading" => esc_html__("Team style", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select style to display team members", 'charity-is-hope') ),
						"class" => "",
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses_data( __("Use slider to show team members", 'charity-is-hope') ),
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses_data( __("Slider controls style and position", 'charity-is-hope') ),
						"admin_label" => true,
						"group" => esc_html__('Slider', 'charity-is-hope'),
						'dependency' => array(
							'element' => 'slider',
					...
					array(
						...
						"description" => wp_kses_data( __("Alignment of the team block", 'charity-is-hope') ),
						"class" => "",
					...
					array(
						"param_name" => "custom",
						"heading" => esc_html__("Custom", 'charity-is-hope'),
						"description" => wp_kses_data( __("Allow get team members from inner shortcodes (custom) or get it from specified group (cat)", 'charity-is-hope') ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Select category to show team members. If empty - select team members from any category (group) or from IDs list", 'charity-is-hope') ),
						...
						"class" => "",
						"value" => array_flip(charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $team_groups)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "columns",
						"heading" => esc_html__("Columns", 'charity-is-hope'),
						"description" => wp_kses_data( __("How many columns use to show team members", 'charity-is-hope') ),
						"group" => esc_html__('Query', 'charity-is-hope'),
						"admin_label" => true,
						"class" => "",
						"value" => "3",
					...
					array(
						"param_name" => "ids",
						"heading" => esc_html__("Team member's IDs list", 'charity-is-hope'),
						"description" => wp_kses_data( __("Comma separated list of team members's ID. If set - parameters above (category, count, order, etc.)  are ignored!", 'charity-is-hope') ),
						"group" => esc_html__('Query', 'charity-is-hope'),
						'dependency' => array(
							'element' => 'custom',
							'is_empty' => true
				...
				'default_content' => '
					[trx_team_item user="' . esc_html__( 'Member 1', 'charity-is-hope' ) . '"][/trx_team_item]
					[trx_team_item user="' . esc_html__( 'Member 2', 'charity-is-hope' ) . '"][/trx_team_item]
					[trx_team_item user="' . esc_html__( 'Member 4', 'charity-is-hope' ) . '"][/trx_team_item]
				',
		...
		vc_map( array(
				"base" => "trx_team_item",
				"name" => esc_html__("Team member", 'charity-is-hope'),
				"description" => wp_kses_data( __("Team member - all data pull out from it account on your site", 'charity-is-hope') ),
				"show_settings_on_create" => true,
				...
				"params" => array(
					array(
						"param_name" => "user",
						"heading" => esc_html__("Registered user", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select one of registered users (if present) or put name, position, etc. in fields below", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
					...
					array(
						"param_name" => "member",
						"heading" => esc_html__("Team member", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select one of team members (if present) or put name, position, etc. in fields below", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Link on team member's personal page", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "name",
						"heading" => esc_html__("Name", 'charity-is-hope'),
						"description" => wp_kses_data( __("Team member's name", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						"param_name" => "position",
						"heading" => esc_html__("Position", 'charity-is-hope'),
						"description" => wp_kses_data( __("Team member's position", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						"param_name" => "email",
						"heading" => esc_html__("E-mail", 'charity-is-hope'),
						"description" => wp_kses_data( __("Team member's e-mail", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "photo",
						"heading" => esc_html__("Member's Photo", 'charity-is-hope'),
						"description" => wp_kses_data( __("Team member's photo (avatar)", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
					array(
						"param_name" => "socials",
						"heading" => esc_html__("Socials", 'charity-is-hope'),
						"description" => wp_kses_data( __("Team member's socials icons: name=url|name=url... For example: facebook=http://facebook.com/myaccount|twitter=http://twitter.com/myaccount", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
