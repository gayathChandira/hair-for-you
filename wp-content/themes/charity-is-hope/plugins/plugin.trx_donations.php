	...
	function charity_is_hope_donations_frontend_scripts() {
		if (charity_is_hope_exists_trx_donations())
			if (file_exists(charity_is_hope_get_file_dir('css/plugin.donations.css')))
				wp_enqueue_style( 'charity_is_hope-plugin.donations-style',  charity_is_hope_get_file_url('css/plugin.donations.css'), array(), null );
	}
}
...
if (!function_exists('charity_is_hope_trx_donations_reg_shortcodes')) {
	//add_filter('charity_is_hope_action_shortcodes_list',	'charity_is_hope_trx_donations_reg_shortcodes');
...
if (!function_exists('charity_is_hope_trx_donations_reg_shortcodes_vc')) {
	//add_filter('charity_is_hope_action_shortcodes_list_vc',	'charity_is_hope_trx_donations_reg_shortcodes_vc');
