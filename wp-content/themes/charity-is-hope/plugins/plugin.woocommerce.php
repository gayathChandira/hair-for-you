	...
	function charity_is_hope_woocommerce_theme_setup() {
		...
		if (charity_is_hope_exists_woocommerce()) {
			...
			if (is_admin()) {
				...
				add_action( 'charity_is_hope_action_importer_import',				'charity_is_hope_woocommerce_importer_import', 10, 2 );
...
if ( !function_exists( 'charity_is_hope_woocommerce_orderby_need' ) ) {
	//add_filter('charity_is_hope_filter_orderby_need',	'charity_is_hope_woocommerce_orderby_need', 9, 1);
...
if ( !function_exists( 'charity_is_hope_woocommerce_list_post_types' ) ) {
	//add_filter('charity_is_hope_filter_list_post_types', 	'charity_is_hope_woocommerce_list_post_types', 10, 1);
	...
	function charity_is_hope_woocommerce_frontend_scripts() {
		if (charity_is_hope_is_woocommerce_page() || charity_is_hope_get_custom_option('show_cart')=='always')
			if (file_exists(charity_is_hope_get_file_dir('css/plugin.woocommerce.css')))
				wp_enqueue_style( 'charity_is_hope-plugin.woocommerce-style',  charity_is_hope_get_file_url('css/plugin.woocommerce.css'), array(), null );
	}
}
...
if ( !function_exists( 'charity_is_hope_woocommerce_loop_shop_columns_class' ) ) {
	//add_filter( 'post_class', 'charity_is_hope_woocommerce_loop_shop_columns_class' );
	//add_filter( 'product_cat_class', 'charity_is_hope_woocommerce_loop_shop_columns_class', 10, 3 );
...
if ( !function_exists( 'charity_is_hope_woocommerce_the_title' ) ) {
	//add_filter( 'the_title', 'charity_is_hope_woocommerce_the_title' );
...
if ( !function_exists( 'charity_is_hope_woocommerce_pagination' ) ) {
	//add_filter( 'woocommerce_after_shop_loop', 'charity_is_hope_woocommerce_pagination', 10 );
...
// Import posts
if ( !function_exists( 'charity_is_hope_woocommerce_importer_import' ) ) {
	//add_action( 'charity_is_hope_action_importer_import',	'charity_is_hope_woocommerce_importer_import', 10, 2 );
	function charity_is_hope_woocommerce_importer_import($importer, $action) {
		if ( $action == 'import_woocommerce' ) {
			$importer->response['start_from_id'] = 0;
			$importer->import_dump('woocommerce', esc_html__('WooCommerce meta', 'charity-is-hope'));
...
if ( !function_exists( 'charity_is_hope_woocommerce_reg_shortcodes_vc' ) ) {
	//add_action('charity_is_hope_action_shortcodes_list_vc', 'charity_is_hope_woocommerce_reg_shortcodes_vc');
