...
if (!function_exists('charity_is_hope_testimonial_theme_setup')) {
	...
	function charity_is_hope_testimonial_theme_setup() {
		...
		charity_is_hope_storage_set('testimonial_override_options', array(
			...
			'title' => esc_html__('Testimonial Details', 'charity-is-hope'),
			'page' => 'testimonial',
			'context' => 'normal',
			'priority' => 'high',
			'fields' => array(
				"testimonial_author" => array(
					"title" => esc_html__('Testimonial author',  'charity-is-hope'),
					"desc" => wp_kses_data( __("Name of the testimonial's author", 'charity-is-hope') ),
					"class" => "testimonial_author",
					"std" => "",
					"type" => "text"),
				"testimonial_position" => array(
					"title" => esc_html__("Author's position",  'charity-is-hope'),
					"desc" => wp_kses_data( __("Position of the testimonial's author", 'charity-is-hope') ),
					"class" => "testimonial_author",
					"std" => "",
					"type" => "text"),
				"testimonial_email" => array(
					"title" => esc_html__("Author's e-mail",  'charity-is-hope'),
					"desc" => wp_kses_data( __("E-mail of the testimonial's author - need to take Gravatar (if registered)", 'charity-is-hope') ),
					"class" => "testimonial_email",
					"std" => "",
					"type" => "text"),
				"testimonial_link" => array(
					"title" => esc_html__('Testimonial link',  'charity-is-hope'),
					"desc" => wp_kses_data( __("URL of the testimonial source or author profile page", 'charity-is-hope') ),
...
if (!function_exists('charity_is_hope_testimonials_reg_shortcodes')) {
	//add_filter('charity_is_hope_action_shortcodes_list',	'charity_is_hope_testimonials_reg_shortcodes');
		...
		if (charity_is_hope_storage_isset('shortcodes')) {
			...
			charity_is_hope_sc_map_before('trx_title', array(
				...
				"trx_testimonials" => array(
					"title" => esc_html__("Testimonials", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Insert testimonials into post (page)", 'charity-is-hope') ),
					"decorate" => true,
					"container" => false,
					"params" => array(
						"title" => array(
						...
						"style" => array(
							"title" => esc_html__("Testimonials style", 'charity-is-hope'),
							"desc" => wp_kses_data( __("Select style to display testimonials", 'charity-is-hope') ),
						...
						"columns" => array(
							...
							"desc" => wp_kses_data( __("How many columns use to show testimonials", 'charity-is-hope') ),
							"value" => 1,
							"min" => 1,
							"max" => 6,
							"step" => 1,
						...
						"slider" => array(
							...
							"desc" => wp_kses_data( __("Use slider to show testimonials", 'charity-is-hope') ),
							"value" => "yes",
							"type" => "switch",
						...
						"align" => array(
							...
							"desc" => wp_kses_data( __("Alignment of the testimonials block", 'charity-is-hope') ),
							"divider" => true,
							"value" => "",
							"type" => "checklist",
							"dir" => "horizontal",
						...
						"custom" => array(
							...
							"desc" => wp_kses_data( __("Allow get testimonials from inner shortcodes (custom) or get it from specified group (cat)", 'charity-is-hope') ),
							"divider" => true,
							"value" => "no",
							"type" => "switch",
							"options" => charity_is_hope_get_sc_param('yes_no')
						...
						"cat" => array(
							...
							"desc" => wp_kses_data( __("Select categories (groups) to show testimonials. If empty - select testimonials from any category (group) or from IDs list", 'charity-is-hope') ),
							"dependency" => array(
								'custom' => array('no')
							),
							"divider" => true,
							...
							"style" => "list",
							"multiple" => true,
							"options" => charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $testimonials_groups)
						),
						"count" => array(
					...
					"children" => array(
						...
						"desc" => wp_kses_data( __("Testimonials item (custom parameters)", 'charity-is-hope') ),
						"container" => true,
						"params" => array(
							"author" => array(
								"title" => esc_html__("Author", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Name of the testimonmials author", 'charity-is-hope') ),
								"value" => "",
								"type" => "text"
							),
							"link" => array(
								"title" => esc_html__("Link", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Link URL to the testimonmials author page", 'charity-is-hope') ),
								"value" => "",
								"type" => "text"
							),
							"email" => array(
								"title" => esc_html__("E-mail", 'charity-is-hope'),
								"desc" => wp_kses_data( __("E-mail of the testimonmials author (to get gravatar)", 'charity-is-hope') ),
								"value" => "",
								"type" => "text"
							),
							"photo" => array(
								"title" => esc_html__("Photo", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Select or upload photo of testimonmials author or write URL of photo from other site", 'charity-is-hope') ),
								"value" => "",
								"type" => "media"
							),
							"_content_" => array(
								"title" => esc_html__("Testimonials text", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Current testimonials text", 'charity-is-hope') ),
								"divider" => true,
								"rows" => 4,
								"value" => "",
								"type" => "textarea"
...
if (!function_exists('charity_is_hope_testimonials_reg_shortcodes_vc')) {
	//add_filter('charity_is_hope_action_shortcodes_list_vc',	'charity_is_hope_testimonials_reg_shortcodes_vc');
	function charity_is_hope_testimonials_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"name" => esc_html__("Testimonials", 'charity-is-hope'),
				"description" => wp_kses_data( __("Insert testimonials slider", 'charity-is-hope') ),
				...
				"params" => array(
					array(
						"param_name" => "style",
						"heading" => esc_html__("Testimonials style", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select style to display testimonials", 'charity-is-hope') ),
						"class" => "",
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses_data( __("Use slider to show testimonials", 'charity-is-hope') ),
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses_data( __("Alignment of the testimonials block", 'charity-is-hope') ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Allow get testimonials from inner shortcodes (custom) or get it from specified group (cat)", 'charity-is-hope') ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Select categories (groups) to show testimonials. If empty - select testimonials from any category (group) or from IDs list", 'charity-is-hope') ),
						...
						"class" => "",
						"value" => array_flip(charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $testimonials_groups)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "columns",
						"heading" => esc_html__("Columns", 'charity-is-hope'),
						"description" => wp_kses_data( __("How many columns use to show testimonials", 'charity-is-hope') ),
						"group" => esc_html__('Query', 'charity-is-hope'),
						"admin_label" => true,
						"class" => "",
						"value" => "1",
		...
		vc_map( array(
				...
				"name" => esc_html__("Testimonial", 'charity-is-hope'),
				"description" => wp_kses_data( __("Single testimonials item", 'charity-is-hope') ),
				"show_settings_on_create" => true,
				...
				"params" => array(
					array(
						...
						"description" => wp_kses_data( __("Name of the testimonmials author", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => wp_kses_data( __("Link URL to the testimonmials author page", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"description" => wp_kses_data( __("E-mail of the testimonmials author", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "photo",
						"heading" => esc_html__("Photo", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select or upload photo of testimonmials author or write URL of photo from other site", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
					...
					array(
						"param_name" => "content",
						"heading" => esc_html__("Testimonials text", 'charity-is-hope'),
						"description" => wp_kses_data( __("Current testimonials text", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textarea_html"
					),
