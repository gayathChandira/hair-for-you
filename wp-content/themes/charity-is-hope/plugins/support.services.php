	...
	function charity_is_hope_services_get_blog_title($title, $page) {
		...
		if ( charity_is_hope_strpos($page, 'services')!==false ) {
			if ( $page == 'services_category' ) {
				...
				$title = esc_html__('All services', 'charity-is-hope');
			}
		}
		return $title;
	}
...
if ( !function_exists( 'charity_is_hope_sc_services' ) ) {
	function charity_is_hope_sc_services($atts, $content=null){	
		...
		extract(charity_is_hope_html_decode(shortcode_atts(array(
			...
			"orderby" => "date",
			"order" => "desc",
			"readmore" => esc_html__('Learn more', 'charity-is-hope'),
			"title" => "",
			"subtitle" => "",
			"description" => "",
						...
						: ($columns > 1 
							? ($style == 'services-5' && !empty($image) 
								? '<div class="sc_service_container sc_align_'.esc_attr($image_align).'">'
									. '<div class="sc_services_image"><img src="'.esc_url($image).'" alt="'.esc_attr__('Image', 'charity-is-hope').'"></div>'
								: '')
...
if (!function_exists('charity_is_hope_services_reg_shortcodes')) {
	//add_filter('charity_is_hope_action_shortcodes_list',	'charity_is_hope_services_reg_shortcodes');
	function charity_is_hope_services_reg_shortcodes() {
		if (charity_is_hope_storage_isset('shortcodes')) {
			...
			charity_is_hope_sc_map_after('trx_section', array(
				...
				// Services
				"trx_services" => array(
					"title" => esc_html__("Services", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Insert services list in your page (post)", 'charity-is-hope') ),
					"decorate" => true,
					"container" => false,
					"params" => array(
						"title" => array(
						...
						"style" => array(
							"title" => esc_html__("Services style", 'charity-is-hope'),
							"desc" => wp_kses_data( __("Select style to display services list", 'charity-is-hope') ),
							"value" => "services-1",
							"type" => "select",
							"options" => $services_styles
						),
						"image" => array(
								"title" => esc_html__("Item's image", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Item's image", 'charity-is-hope') ),
								"dependency" => array(
									'style' => 'services-5'
								),
								"value" => "",
						...
						"image_align" => array(
							"title" => esc_html__("Image alignment", 'charity-is-hope'),
							"desc" => wp_kses_data( __("Alignment of the image", 'charity-is-hope') ),
							"divider" => true,
							"value" => "",
							"type" => "checklist",
							"dir" => "horizontal",
						...
						"type" => array(
							"title" => esc_html__("Icon's type", 'charity-is-hope'),
							"desc" => wp_kses_data( __("Select type of icons: font icon or image", 'charity-is-hope') ),
							"value" => "icons",
							"type" => "checklist",
							"dir" => "horizontal",
							"options" => array(
								'icons'  => esc_html__('Icons', 'charity-is-hope'),
								'images' => esc_html__('Images', 'charity-is-hope')
							)
						),
						"columns" => array(
							"title" => esc_html__("Columns", 'charity-is-hope'),
							"desc" => wp_kses_data( __("How many columns use to show services list", 'charity-is-hope') ),
							"value" => 4,
							"min" => 2,
							"max" => 6,
							"step" => 1,
						...
						"slider" => array(
							...
							"desc" => wp_kses_data( __("Use slider to show services", 'charity-is-hope') ),
							"value" => "no",
							"type" => "switch",
						...
						"align" => array(
							...
							"desc" => wp_kses_data( __("Alignment of the services block", 'charity-is-hope') ),
							"divider" => true,
							"value" => "",
							"type" => "checklist",
							"dir" => "horizontal",
						...
						"custom" => array(
							...
							"desc" => wp_kses_data( __("Allow get services items from inner shortcodes (custom) or get it from specified group (cat)", 'charity-is-hope') ),
							"divider" => true,
							"value" => "no",
							"type" => "switch",
							"options" => charity_is_hope_get_sc_param('yes_no')
						...
						"cat" => array(
							...
							"desc" => wp_kses_data( __("Select categories (groups) to show services list. If empty - select services from any category (group) or from IDs list", 'charity-is-hope') ),
							"dependency" => array(
								'custom' => array('no')
							),
							"divider" => true,
							...
							"style" => "list",
							"multiple" => true,
							"options" => charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $services_groups)
						),
						"count" => array(
						...
						"readmore" => array(
							...
							"desc" => wp_kses_data( __("Caption for the Read more link (if empty - link not showed)", 'charity-is-hope') ),
							"value" => "",
							"type" => "text"
						),
						"link" => array(
					...
					"children" => array(
						...
						"title" => esc_html__("Service item", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Service item", 'charity-is-hope') ),
						"container" => true,
						"params" => array(
							"title" => array(
								"title" => esc_html__("Title", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Item's title", 'charity-is-hope') ),
								"divider" => true,
								"value" => "",
								"type" => "text"
							),
							"icon" => array(
								"title" => esc_html__("Item's icon",  'charity-is-hope'),
								"desc" => wp_kses_data( __('Select icon for the item from Fontello icons set',  'charity-is-hope') ),
								"value" => "",
								"type" => "icons",
							...
							"image" => array(
								"title" => esc_html__("Item's image", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Item's image (if icon not selected)", 'charity-is-hope') ),
								"dependency" => array(
							...
							"link" => array(
								...
								"desc" => wp_kses_data( __("Link on service's item page", 'charity-is-hope') ),
								"divider" => true,
								"value" => "",
								"type" => "text"
							),
							...
							"_content_" => array(
								"title" => esc_html__("Description", 'charity-is-hope'),
								"desc" => wp_kses_data( __("Item's short description", 'charity-is-hope') ),
								"divider" => true,
								"rows" => 4,
								"value" => "",
								"type" => "textarea"
...
if (!function_exists('charity_is_hope_services_reg_shortcodes_vc')) {
	//add_filter('charity_is_hope_action_shortcodes_list_vc',	'charity_is_hope_services_reg_shortcodes_vc');
	function charity_is_hope_services_reg_shortcodes_vc() {
		...
		vc_map( array(
				"base" => "trx_services",
				"name" => esc_html__("Services", 'charity-is-hope'),
				"description" => wp_kses_data( __("Insert services list", 'charity-is-hope') ),
				...
				"params" => array(
					array(
						"param_name" => "style",
						"heading" => esc_html__("Services style", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select style to display services list", 'charity-is-hope') ),
						"class" => "",
						"admin_label" => true,
					...
					array(
						"param_name" => "type",
						"heading" => esc_html__("Icon's type", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select type of icons: font icon or image", 'charity-is-hope') ),
						"class" => "",
						"admin_label" => true,
						"value" => array(
							esc_html__('Icons', 'charity-is-hope') => 'icons',
							esc_html__('Images', 'charity-is-hope') => 'images'
						),
						"type" => "dropdown"
					),
					array(
						"param_name" => "equalheight",
						"heading" => esc_html__("Equal height", 'charity-is-hope'),
						"description" => wp_kses_data( __("Make equal height for all items in the row", 'charity-is-hope') ),
					...
					array(
						"param_name" => "image",
						"heading" => esc_html__("Image", 'charity-is-hope'),
						"description" => wp_kses_data( __("Item's image", 'charity-is-hope') ),
						'dependency' => array(
							'element' => 'style',
							'value' => 'services-5'
						),
					...
					array(
						...
						"description" => wp_kses_data( __("Alignment of the image", 'charity-is-hope') ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Use slider to show services", 'charity-is-hope') ),
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses_data( __("Alignment of the services block", 'charity-is-hope') ),
						"class" => "",
						"value" => array_flip(charity_is_hope_get_sc_param('align')),
						"type" => "dropdown"
					),
					array(
						...
						"description" => wp_kses_data( __("Allow get services from inner shortcodes (custom) or get it from specified group (cat)", 'charity-is-hope') ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Select category to show services. If empty - select services from any category (group) or from IDs list", 'charity-is-hope') ),
						...
						"class" => "",
						"value" => array_flip(charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $services_groups)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "columns",
						"heading" => esc_html__("Columns", 'charity-is-hope'),
						"description" => wp_kses_data( __("How many columns use to show services list", 'charity-is-hope') ),
						"group" => esc_html__('Query', 'charity-is-hope'),
						"admin_label" => true,
						"class" => "",
						"value" => "4",
					...
					array(
						"param_name" => "ids",
						"heading" => esc_html__("Service's IDs list", 'charity-is-hope'),
						"description" => wp_kses_data( __("Comma separated list of service's ID. If set - parameters above (category, count, order, etc.)  are ignored!", 'charity-is-hope') ),
						"group" => esc_html__('Query', 'charity-is-hope'),
						'dependency' => array(
							'element' => 'custom',
							'is_empty' => true
					...
					array(
						...
						"description" => wp_kses_data( __("Caption for the Read more link (if empty - link not showed)", 'charity-is-hope') ),
						"admin_label" => true,
						"group" => esc_html__('Captions', 'charity-is-hope'),
						"class" => "",
						"value" => "",
				...
				'default_content' => '
					[trx_services_item title="' . esc_html__( 'Service item 1', 'charity-is-hope' ) . '"][/trx_services_item]
					[trx_services_item title="' . esc_html__( 'Service item 2', 'charity-is-hope' ) . '"][/trx_services_item]
					[trx_services_item title="' . esc_html__( 'Service item 3', 'charity-is-hope' ) . '"][/trx_services_item]
					[trx_services_item title="' . esc_html__( 'Service item 4', 'charity-is-hope' ) . '"][/trx_services_item]
				',
		...
		vc_map( array(
				...
				"name" => esc_html__("Services item", 'charity-is-hope'),
				"description" => wp_kses_data( __("Custom services item - all data pull out from shortcode parameters", 'charity-is-hope') ),
				"show_settings_on_create" => true,
				...
				"params" => array(
					array(
						"param_name" => "title",
						"heading" => esc_html__("Title", 'charity-is-hope'),
						"description" => wp_kses_data( __("Item's title", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => wp_kses_data( __("Select icon for the item from Fontello icons set", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
					...
					array(
						"param_name" => "image",
						"heading" => esc_html__("Image", 'charity-is-hope'),
						"description" => wp_kses_data( __("Item's image (if icon is empty)", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
					array(
						...
						"description" => wp_kses_data( __("Link on item's page", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
