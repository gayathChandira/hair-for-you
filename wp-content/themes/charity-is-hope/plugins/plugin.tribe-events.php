		...
		if (charity_is_hope_exists_tribe_events()) {
			...
			charity_is_hope_storage_set_array_before('options', 'partition_reviews', array(
				...
				"partition_tribe_events" => array(
						"title" => __('Events', 'charity-is-hope'),
						"icon" => "iconadmin-clock",
						"type" => "partition"),
			
				"info_tribe_events_1" => array(
						"title" => __('Events settings', 'charity-is-hope'),
						"desc" => __('Set up events posts behaviour in the blog.', 'charity-is-hope'),
						"type" => "info"),
			
				"show_tribe_events_in_blog" => array(
						"title" => __('Show events in the blog',  'charity-is-hope'),
						"desc" => __("Show events in stream pages (blog, archives) or only in special pages", 'charity-is-hope'),
						"divider" => false,
						"std" => "yes",
...
if ( !function_exists( 'charity_is_hope_tribe_events_get_blog_type' ) ) {
	//add_filter('charity_is_hope_filter_get_blog_type',	'charity_is_hope_tribe_events_get_blog_type', 10, 2);
...
if ( !function_exists( 'charity_is_hope_tribe_events_get_blog_title' ) ) {
	//add_filter('charity_is_hope_filter_get_blog_title',	'charity_is_hope_tribe_events_get_blog_title', 10, 2);
	function charity_is_hope_tribe_events_get_blog_title($title, $page) {
		...
		if ( charity_is_hope_strpos($page, 'tribe')!==false ) {
			if ( $page == 'tribe_category' ) {
				...
				$title = sprintf( esc_html__( 'Tag: %s', 'charity-is-hope' ), single_tag_title( '', false ) );
...
if ( !function_exists( 'charity_is_hope_tribe_events_is_taxonomy' ) ) {
	//add_filter('charity_is_hope_filter_is_taxonomy',	'charity_is_hope_tribe_events_is_taxonomy', 10, 2);
...
if ( !function_exists( 'charity_is_hope_tribe_events_frontend_scripts' ) ) {
	...
	function charity_is_hope_tribe_events_frontend_scripts() {
		...
		if (file_exists(charity_is_hope_get_file_dir('css/plugin.tribe-events.css')))
			wp_enqueue_style( 'charity_is_hope-plugin.tribe-events-style',  charity_is_hope_get_file_url('css/plugin.tribe-events.css'), array(), null );
	}
}
...
if ( !function_exists( 'charity_is_hope_tribe_events_wrapper_start' ) ) {
	//add_filter('tribe_events_before_html', 'charity_is_hope_tribe_events_wrapper_start');
...
if ( !function_exists( 'charity_is_hope_tribe_events_wrapper_end' ) ) {
	//add_filter('tribe_events_after_html', 'charity_is_hope_tribe_events_wrapper_end');
...
if ( !function_exists( 'charity_is_hope_tribe_events_orderby_need' ) ) {
	//add_filter('charity_is_hope_filter_orderby_need',	'charity_is_hope_tribe_events_orderby_need', 9, 1);
...
if ( !function_exists( 'charity_is_hope_tribe_events_posts_join' ) ) {
	// add_action( 'posts_join', 'charity_is_hope_tribe_events_posts_join', 10, 2 );
...
if ( !function_exists( 'charity_is_hope_tribe_events_getarchives_join' ) ) {
	// add_action( 'getarchives_join', 'charity_is_hope_tribe_events_getarchives_join', 10, 2 );
...
if ( !function_exists( 'charity_is_hope_tribe_events_posts_where' ) ) {
	// add_action( 'posts_where', 'charity_is_hope_tribe_events_posts_where', 10, 2 );
...
if ( !function_exists( 'charity_is_hope_tribe_events_getarchives_where' ) ) {
	// add_action( 'getarchives_where', 'charity_is_hope_tribe_events_getarchives_where', 10, 2 );
...
if (!function_exists('charity_is_hope_tribe_events_reg_shortcodes')) {
	//add_filter('charity_is_hope_action_shortcodes_list',	'charity_is_hope_tribe_events_reg_shortcodes');
...
if (!function_exists('charity_is_hope_tribe_events_reg_shortcodes_vc')) {
	//add_filter('charity_is_hope_action_shortcodes_list_vc',	'charity_is_hope_tribe_events_reg_shortcodes_vc');
