...
if (!function_exists('charity_is_hope_action_theme_styles_no_less_add_styles')) {
	function charity_is_hope_action_theme_styles_no_less_add_styles() {
		...
		if ( !is_customize_preview() && !isset($_GET['color_scheme']) && charity_is_hope_param_is_off(charity_is_hope_get_theme_option('debug_mode')) ) {
			wp_enqueue_style( 'charity_is_hope-theme-style', charity_is_hope_get_file_url('css/theme.css'), array(), null );
			wp_add_inline_style( 'charity_is_hope-theme-style', charity_is_hope_get_inline_css() );
		} else {
			wp_add_inline_style( 'charity_is_hope-main-style', charity_is_hope_get_custom_css() . charity_is_hope_get_inline_css() );
		}
	}
}
...
if (!function_exists('charity_is_hope_get_custom_css')) {
	...
	function charity_is_hope_get_custom_css($colors=null, $fonts=null, $minify=true, $only_scheme='') {
		...
		$add_comment = $colors===null && $fonts===null && empty($only_scheme)
						? '/* ' . strip_tags( __("ATTENTION! This file was generated automatically! Don't change it!!!", 'charity-is-hope') ) . "*/\n"
						: '';
...
#tribe-bar-form .tribe-bar-submit input[type="submit"], .tribe-events-button, #tribe-events .tribe-events-button, #tribe-bar-form .tribe-bar-submit input[type="submit"], a.tribe-events-read-more, .tribe-events-button, .tribe-events-nav-previous a, .tribe-events-nav-next a, .tribe-events-widget-link a, .tribe-events-viewmore a {
	background-color: {$colors['text_link']};
	color: {$colors['inverse_text']};
}
