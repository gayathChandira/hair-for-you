...
if ($show_all_counters && charity_is_hope_strpos($post_options['counters'], 'views')!==false) {
	?>
	<<?php charity_is_hope_show_layout($counters_tag); ?> class="post_counters_item post_counters_views icon-eye-inv" title="<?php echo esc_attr( sprintf(__('Views - %s', 'charity-is-hope'), $post_data['post_views']) ); ?>" href="<?php echo esc_url($post_data['post_link']); ?>"><span class="post_counters_number"><?php charity_is_hope_show_layout($post_data['post_views']); ?></span><?php if (charity_is_hope_strpos($post_options['counters'], 'captions')!==false) echo ' '.esc_html__('Views', 'charity-is-hope'); ?></<?php charity_is_hope_show_layout($counters_tag); ?>>
	<?php
}
...
if ($rating > 0 && ($show_all_counters && charity_is_hope_strpos($post_options['counters'], 'rating')!==false)) { 
	?>
	<<?php charity_is_hope_show_layout($counters_tag); ?> class="post_counters_item post_counters_rating icon-star" title="<?php echo esc_attr( sprintf(__('Rating - %s', 'charity-is-hope'), $rating) ); ?>" href="<?php echo esc_url($post_data['post_link']); ?>"><span class="post_counters_number"><?php charity_is_hope_show_layout($rating); ?></span></<?php charity_is_hope_show_layout($counters_tag); ?>>
	<?php
}
