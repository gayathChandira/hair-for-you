...
if (!function_exists('charity_is_hope_template_gallery_add_scripts')) {
	...
	function charity_is_hope_template_gallery_add_scripts($style) {
		if (charity_is_hope_substr($style, 0, 8) == 'gallery_') {
			...
			wp_enqueue_script( 'charity_is_hope-gallery-script', charity_is_hope_get_file_url('js/core.gallery/core.gallery.js'), array(), null, true );
			wp_enqueue_style(  'charity_is_hope-gallery-style', charity_is_hope_get_file_url('css/core.gallery.css'), array(), null );
		}
	}
}
