...
if (!empty($in_shortcode)) {
	?><div id="post-<?php echo $form_id; ?>" class="post_item_<?php echo esc_attr($blog_style); ?> post_type_<?php echo esc_attr(get_post_type()).' '.esc_attr($column_class); ?>"><?php
} else {
	?><article id="post-<?php echo $form_id; ?>" <?php post_class( 'post_item_'.esc_attr($blog_style).' post_type_'.esc_attr(get_post_type()).' '.esc_attr($column_class) ); ?>><?php
}
	// Post thumbnail
