...
define('GDPR_FRAMEWORK_VERSION', '1.0.20');
...
/*
* Create user log table on plugin update.
*/
...
function create_user_Table(){
   ...
   // $model->createClassiDocsCallback(); will use in future.
}
...
function popup_gdpr(){
    ...
    if(get_option('gdpr_policy_popup'))
    {
    ...
    if($gdpr_header != ""){ 
        ...
        $gdpr_header= __('Cookies used on the website!', 'gdpr-framework');
    }
