...
class charity_is_hope_widget_categories extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget_subcategories', 'description' => esc_html__('Display subcategories list', 'charity-is-hope') );
		parent::__construct( 'charity_is_hope_widget_subcategories', esc_html__('Charity Is Hope - Subcategories list', 'charity-is-hope'), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		<div class="widget_subcategories_inner">
			<?php
			if ( $d ) {
				$cat_args['show_option_none'] = esc_html__('Select Category', 'charity-is-hope');
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('root')); ?>"><?php esc_html_e('Root category:', 'charity-is-hope'); ?></label>
		...
		<label for="<?php echo esc_attr($this->get_field_id('dropdown')); ?>"><?php esc_html_e( 'Display as dropdown', 'charity-is-hope' ); ?></label><br />

		<input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id('count')); ?>" name="<?php echo esc_attr($this->get_field_name('count')); ?>"<?php checked( $count ); ?> />
		<label for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php esc_html_e( 'Show post counts', 'charity-is-hope' ); ?></label><br />

		<input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id('hierarchical')); ?>" name="<?php echo esc_attr($this->get_field_name('hierarchical')); ?>"<?php checked( $hierarchical ); ?> />
		<label for="<?php echo esc_attr($this->get_field_id('hierarchical')); ?>"><?php esc_html_e( 'Show hierarchy', 'charity-is-hope' ); ?></label>
		</p>
		<?php
	}
}
...
if (!function_exists('charity_is_hope_widget_categories_reg_shortcodes_vc')) {
	...
	function charity_is_hope_widget_categories_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"name" => esc_html__("Widget Categories", 'charity-is-hope'),
				"description" => wp_kses_data( __("Display the subcategories list for the specified category", 'charity-is-hope') ),
				...
				"params" => array(
					...
					array(
						"param_name" => "count",
						"heading" => esc_html__("Show posts", 'charity-is-hope'),
						"description" => wp_kses_data( __("Show posts number in the each category", 'charity-is-hope') ),
						"class" => "",
						"std" => "1",
						"value" => array(esc_html__('Show posts number', 'charity-is-hope') => "1"),
						"type" => "checkbox"
					),
					array(
						"param_name" => "dropdown",
						"heading" => esc_html__("Show dropdown", 'charity-is-hope'),
						"description" => wp_kses_data( __("Show categories as dropdown list", 'charity-is-hope') ),
						"class" => "",
						"std" => "0",
						"value" => array(esc_html__('Show dropdown', 'charity-is-hope') => "1"),
						"type" => "checkbox"
					),
					array(
						"param_name" => "hierarchical",
						"heading" => esc_html__("Show hierarchical", 'charity-is-hope'),
						"description" => wp_kses_data( __("Show categories as hierarchical list", 'charity-is-hope') ),
						"class" => "",
						"std" => "1",
						"value" => array(esc_html__('Show hierarchical', 'charity-is-hope') => "1"),
						"type" => "checkbox"
					),
					array(
					...
					array(
						...
						"description" => wp_kses_data( __("Select parent category. If empty - show all categories", 'charity-is-hope') ),
						"class" => "",
