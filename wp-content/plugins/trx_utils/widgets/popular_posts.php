...
class charity_is_hope_widget_popular_posts extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_popular_posts', 'description' => esc_html__('The most popular and most commented blog posts (extended)', 'charity-is-hope'));
		parent::__construct( 'charity_is_hope_widget_popular_posts', esc_html__('Charity Is Hope - Most Popular & Commented Posts', 'charity-is-hope'), $widget_ops );

		// Add thumb sizes into list
		charity_is_hope_add_thumb_sizes( array( 'layout' => 'widgets', 'w' => 75, 'h' => 75, 'title'=>esc_html__('Widgets', 'charity-is-hope') ) );
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Widget title:', 'charity-is-hope'); ?></label>
			<input id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($title); ?>" class="widgets_param_fullwidth" />
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_popular')); ?>"><?php esc_html_e('Most popular tab title:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_commented')); ?>"><?php esc_html_e('Most commented tab title:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_liked')); ?>"><?php esc_html_e('Most liked tab title:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>"><?php esc_html_e('Post type:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('category')); ?>"><?php esc_html_e('Category:', 'charity-is-hope'); ?></label>
			<select id="<?php echo esc_attr($this->get_field_id('category')); ?>" name="<?php echo esc_attr($this->get_field_name('category')); ?>" class="widgets_param_fullwidth">
				<option value="0"><?php esc_html_e('-- Any category --', 'charity-is-hope'); ?></option> 
				<?php
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('Number posts to show:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('show_image')); ?>_1"><?php esc_html_e('Show post image:', 'charity-is-hope'); ?></label><br />
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_image')); ?>_1"><?php esc_html_e('Show', 'charity-is-hope'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_image')); ?>_0"><?php esc_html_e('Hide', 'charity-is-hope'); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('show_author')); ?>_1"><?php esc_html_e('Show post author:', 'charity-is-hope'); ?></label><br />
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_author')); ?>_1"><?php esc_html_e('Show', 'charity-is-hope'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_author')); ?>_0"><?php esc_html_e('Hide', 'charity-is-hope'); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('show_date')); ?>_1"><?php esc_html_e('Show post date:', 'charity-is-hope'); ?></label><br />
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_date')); ?>_1"><?php esc_html_e('Show', 'charity-is-hope'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_date')); ?>_0"><?php esc_html_e('Hide', 'charity-is-hope'); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php esc_html_e('Show post counters:', 'charity-is-hope'); ?></label><br />
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php esc_html_e('Show', 'charity-is-hope'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_0"><?php esc_html_e('Hide', 'charity-is-hope'); ?></label>
		</p>
...
if (!function_exists('charity_is_hope_widget_popular_posts_reg_shortcodes_vc')) {
	...
	function charity_is_hope_widget_popular_posts_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"name" => esc_html__("Widget Popular Posts", 'charity-is-hope'),
				"description" => wp_kses_data( __("Insert popular posts list with thumbs and post's meta", 'charity-is-hope') ),
				...
				"params" => array(
					array(
						"param_name" => "title",
						"heading" => esc_html__("Widget title", 'charity-is-hope'),
						"description" => wp_kses_data( __("Title of the widget", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"heading" => esc_html__("Most popular tab title", 'charity-is-hope'),
						"description" => wp_kses_data( __("Most popular tab title", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"heading" => esc_html__("Most commented tab title", 'charity-is-hope'),
						"description" => wp_kses_data( __("Most commented tab title", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"heading" => esc_html__("Most liked tab title", 'charity-is-hope'),
						"description" => wp_kses_data( __("Most liked tab title", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "number",
						"heading" => esc_html__("Number posts to show", 'charity-is-hope'),
						"description" => wp_kses_data( __("How many posts display in widget?", 'charity-is-hope') ),
						"admin_label" => true,
						"class" => "",
						"value" => "4",
						"type" => "textfield"
					...
					array(
						"param_name" => "cat",
						"heading" => esc_html__("Parent category", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select parent category. If empty - show posts from any category", 'charity-is-hope') ),
						"class" => "",
						"value" => array_flip(charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), $categories)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "show_image",
						"heading" => esc_html__("Show post's image", 'charity-is-hope'),
						"description" => wp_kses_data( __("Do you want display post's featured image?", 'charity-is-hope') ),
					...
					array(
						...
						"heading" => esc_html__("Show post's author", 'charity-is-hope'),
						"description" => wp_kses_data( __("Do you want display post's author?", 'charity-is-hope') ),
						"group" => esc_html__('Details', 'charity-is-hope'),
						"class" => "",
						"std" => 1,
					...
					array(
						...
						"heading" => esc_html__("Show post's date", 'charity-is-hope'),
						"description" => wp_kses_data( __("Do you want display post's publish date?", 'charity-is-hope') ),
						"group" => esc_html__('Details', 'charity-is-hope'),
						"class" => "",
						"std" => 1,
					...
					array(
						...
						"heading" => esc_html__("Show post's counters", 'charity-is-hope'),
						"description" => wp_kses_data( __("Do you want display post's counters?", 'charity-is-hope') ),
						"group" => esc_html__('Details', 'charity-is-hope'),
						"class" => "",
						"std" => 1,
