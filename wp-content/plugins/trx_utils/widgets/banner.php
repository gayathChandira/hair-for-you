...
class charity_is_hope_widget_banner extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget_banner', 'description' => esc_html__('Banner', 'charity-is-hope') );
		parent::__construct( 'charity_is_hope_widget_banner', esc_html__('Charity Is Hope - Banner', 'charity-is-hope'), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'banner_image' )); ?>"><?php echo wp_kses_data( __('Image source URL:<br />(leave empty if you paste banner code)', 'charity-is-hope') ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'banner_link' )); ?>"><?php echo wp_kses_data( __('Image link URL:<br />(leave empty if you paste banner code)', 'charity-is-hope') ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'banner_code' )); ?>"><?php esc_html_e('or paste Banner Widget HTML Code:', 'charity-is-hope'); ?></label>
...
if (!function_exists('charity_is_hope_widget_banner_reg_shortcodes_vc')) {
	...
	function charity_is_hope_widget_banner_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"name" => esc_html__("Widget Banner", 'charity-is-hope'),
				"description" => wp_kses_data( __("Insert widget with banner or any HTML and/or Javascript code", 'charity-is-hope') ),
				...
				"params" => array(
					...
					array(
						...
						"description" => wp_kses_data( __("Select or upload image or write URL from other site for the banner (leave empty if you paste banner code)", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
					array(
						"param_name" => "link",
						"heading" => esc_html__("Banner's link", 'charity-is-hope'),
						"description" => wp_kses_data( __("Link URL for the banner (leave empty if you paste banner code)", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "code",
						"heading" => esc_html__("or paste Banner Widget HTML Code", 'charity-is-hope'),
						"description" => wp_kses_data( __("Widget's HTML and/or JS code", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textarea"
					),
