...
class charity_is_hope_widget_top10 extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_top10', 'description' => esc_html__('Top 10 posts by average reviews marks (by author and users)', 'charity-is-hope'));
		parent::__construct( 'charity_is_hope_widget_top10', esc_html__('Charity Is Hope - Top 10 Posts', 'charity-is-hope'), $widget_ops );
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_author')); ?>"><?php esc_html_e('Author rating tab title:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_users')); ?>"><?php esc_html_e('Users rating tab title:', 'charity-is-hope'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_2"><?php esc_html_e('As stars', 'charity-is-hope'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php esc_html_e('As icon', 'charity-is-hope'); ?></label>
...
if (!function_exists('charity_is_hope_widget_top10_reg_shortcodes_vc')) {
	...
	function charity_is_hope_widget_top10_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"name" => esc_html__("Widget Top10 Reviews", 'charity-is-hope'),
				"description" => wp_kses_data( __("Insert Top10 reviews list with thumbs and post's meta", 'charity-is-hope') ),
				...
				"params" => array(
					...
					array(
						...
						"heading" => esc_html__("Author's tab title", 'charity-is-hope'),
						"description" => wp_kses_data( __("Title for the tab with authors's reviews", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"heading" => esc_html__("User's tab title", 'charity-is-hope'),
						"description" => wp_kses_data( __("Title for the tab with authors's reviews", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"value" => array_flip(array(
							'2' => esc_html__('As stars', 'charity-is-hope'),
							'1' => esc_html__('As text', 'charity-is-hope'),
							'0' => esc_html__('Hide', 'charity-is-hope')
						)),
						"type" => "dropdown"
					),
