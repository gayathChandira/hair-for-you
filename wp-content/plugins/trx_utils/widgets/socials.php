...
class charity_is_hope_widget_socials extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget_socials', 'description' => esc_html__('Show site logo and social links', 'charity-is-hope') );
		parent::__construct( 'charity_is_hope_widget_socials', esc_html__('Charity Is Hope - Show logo and social links', 'charity-is-hope'), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php esc_html_e('Description:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'logo_image' )); ?>"><?php echo wp_kses_data( __('Logo image:<br />(if empty - use logo from Theme Options)', 'charity-is-hope') ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'logo_text' )); ?>"><?php esc_html_e('Logo text:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'logo_slogan' )); ?>"><?php esc_html_e('Logo slogan:', 'charity-is-hope'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('show_logo')); ?>_1"><?php esc_html_e('Show logo:', 'charity-is-hope'); ?></label><br />
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_logo')); ?>_1"><?php esc_html_e('Show', 'charity-is-hope'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_logo')); ?>_0"><?php esc_html_e('Hide', 'charity-is-hope'); ?></label>
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('show_icons')); ?>_1"><?php esc_html_e('Show social icons:', 'charity-is-hope'); ?></label><br />
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_icons')); ?>_1"><?php esc_html_e('Show', 'charity-is-hope'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_icons')); ?>_0"><?php esc_html_e('Hide', 'charity-is-hope'); ?></label>
		</p>
...
if (!function_exists('charity_is_hope_widget_socials_reg_shortcodes_vc')) {
	function charity_is_hope_widget_socials_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"name" => esc_html__("Widget Socials", 'charity-is-hope'),
				"description" => wp_kses_data( __("Insert site logo, description and/or socials list", 'charity-is-hope') ),
				...
				"params" => array(
					...
					array(
						"param_name" => "text",
						"heading" => esc_html__("Widget text", 'charity-is-hope'),
						"description" => wp_kses_data( __("Any description", 'charity-is-hope') ),
						"class" => "",
						"value" => "",
						"type" => "textarea"
					),
					array(
						...
						"heading" => esc_html__("Show logo", 'charity-is-hope'),
						"description" => wp_kses_data( __("Do you want display logo image?", 'charity-is-hope') ),
						"class" => "",
						"std" => 1,
					...
					array(
						...
						"heading" => esc_html__("Show social icons", 'charity-is-hope'),
						"description" => wp_kses_data( __("Do you want display social icons?", 'charity-is-hope') ),
						"class" => "",
						"std" => 1,
					...
					array(
						...
						"heading" => esc_html__("Logo image", 'charity-is-hope'),
						"description" => wp_kses_data( __("Select or upload image or write URL from other site for the logo (leave empty if you want use default site logo)", 'charity-is-hope') ),
						'dependency' => array(
							'element' => 'show_logo',
							'not_empty' => true
						),
					...
					array(
						...
						"heading" => esc_html__("Logo text", 'charity-is-hope'),
						"description" => wp_kses_data( __("Site name for the logo(leave empty if you want use default site text)", 'charity-is-hope') ),
						"admin_label" => true,
						'dependency' => array(
							'element' => 'show_logo',
							'not_empty' => true
					...
					array(
						...
						"heading" => esc_html__("Logo slogan", 'charity-is-hope'),
						"description" => wp_kses_data( __("Site slogan for the logo(leave empty if you want use default site tagline)", 'charity-is-hope') ),
						'dependency' => array(
							'element' => 'show_logo',
							'not_empty' => true
						),
