...
if ( !function_exists( 'charity_is_hope_sc_popup_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_popup_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_popup", array(
			"title" => esc_html__("Popup window", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Container for any html-block with desired class and style for popup window", 'charity-is-hope') ),
			"decorate" => true,
			"container" => true,
			"params" => array(
				"_content_" => array(
...
if ( !function_exists( 'charity_is_hope_sc_popup_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_popup_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_popup",
			"name" => esc_html__("Popup window", 'charity-is-hope'),
			"description" => wp_kses_data( __("Container for any html-block with desired class and style for popup window", 'charity-is-hope') ),
