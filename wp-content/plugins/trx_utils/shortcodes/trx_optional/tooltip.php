...
if ( !function_exists( 'charity_is_hope_sc_tooltip_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_tooltip_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_tooltip", array(
			"title" => esc_html__("Tooltip", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Create tooltip for selected text", 'charity-is-hope') ),
			"decorate" => false,
			"container" => true,
			"params" => array(
				"title" => array(
					"title" => esc_html__("Title", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Tooltip title (required)", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"_content_" => array(
					"title" => esc_html__("Tipped content", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Highlighted content with tooltip", 'charity-is-hope') ),
					"divider" => true,
					"rows" => 4,
					"value" => "",
					"type" => "textarea"
