...
if ( !function_exists( 'charity_is_hope_sc_dropcaps_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_dropcaps_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_dropcaps", array(
			"title" => esc_html__("Dropcaps", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Make first letter as dropcaps", 'charity-is-hope') ),
			"decorate" => false,
			"container" => true,
			"params" => array(
				"style" => array(
					"title" => esc_html__("Style", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Dropcaps style", 'charity-is-hope') ),
					"value" => "1",
					"type" => "checklist",
					"options" => charity_is_hope_get_list_styles(1, 4)
				),
				"_content_" => array(
					"title" => esc_html__("Paragraph content", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Paragraph with dropcaps content", 'charity-is-hope') ),
					"divider" => true,
					"rows" => 4,
					"value" => "",
					"type" => "textarea"
...
if ( !function_exists( 'charity_is_hope_sc_dropcaps_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_dropcaps_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_dropcaps",
			"name" => esc_html__("Dropcaps", 'charity-is-hope'),
			"description" => wp_kses_data( __("Make first letter of the text as dropcaps", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses_data( __("Dropcaps style", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
