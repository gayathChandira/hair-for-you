...
if ( !function_exists( 'charity_is_hope_sc_parallax_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_parallax_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_parallax", array(
			"title" => esc_html__("Parallax", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Create the parallax container (with asinc background image)", 'charity-is-hope') ),
			"decorate" => false,
			"container" => true,
			"params" => array(
				"gap" => array(
					"title" => esc_html__("Create gap", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Create gap around parallax container", 'charity-is-hope') ),
					"value" => "no",
					"size" => "small",
				...
				"dir" => array(
					"title" => esc_html__("Dir", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Scroll direction for the parallax background", 'charity-is-hope') ),
					"value" => "up",
					"size" => "medium",
					"options" => array(
						'up' => esc_html__('Up', 'charity-is-hope'),
						'down' => esc_html__('Down', 'charity-is-hope')
					),
					"type" => "switch"
				), 
				"speed" => array(
					"title" => esc_html__("Speed", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Image motion speed (from 0.0 to 1.0)", 'charity-is-hope') ),
					"min" => "0",
					"max" => "1",
					"step" => "0.1",
					"value" => "0.3",
				...
				"color" => array(
					...
					"desc" => wp_kses_data( __("Select color for text object inside parallax block", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "color"
				),
				"bg_color" => array(
					...
					"desc" => wp_kses_data( __("Select color for parallax background", 'charity-is-hope') ),
					"value" => "",
					"type" => "color"
				),
				"bg_image" => array(
					"title" => esc_html__("Background image", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select or upload image or write URL from other site for the parallax background", 'charity-is-hope') ),
					"readonly" => false,
					"value" => "",
					"type" => "media"
				),
				"bg_image_x" => array(
					"title" => esc_html__("Image X position", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Image horizontal position (as background of the parallax block) - in percent", 'charity-is-hope') ),
					"min" => "0",
					"max" => "100",
					"value" => "50",
					"type" => "spinner"
				...
				"bg_video" => array(
					...
					"desc" => wp_kses_data( __("Select video from media library or paste URL for video file from other site to show it as parallax background", 'charity-is-hope') ),
					"readonly" => false,
					"value" => "",
					"type" => "media",
					"before" => array(
				...
				"bg_video_ratio" => array(
					"title" => esc_html__("Video ratio", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Specify ratio of the video background. For example: 16:9 (default), 4:3, etc.", 'charity-is-hope') ),
					"value" => "16:9",
					"type" => "text"
				),
				"bg_overlay" => array(
				...
				"_content_" => array(
					"title" => esc_html__("Content", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Content for the parallax container", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "text"
				),
...
if ( !function_exists( 'charity_is_hope_sc_parallax_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_parallax_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_parallax",
			"name" => esc_html__("Parallax", 'charity-is-hope'),
			"description" => wp_kses_data( __("Create the parallax container (with asinc background image)", 'charity-is-hope') ),
			"category" => esc_html__('Structure', 'charity-is-hope'),
			...
			"params" => array(
				array(
					"param_name" => "gap",
					"heading" => esc_html__("Create gap", 'charity-is-hope'),
					"description" => wp_kses_data( __("Create gap around parallax container (not need in fullscreen pages)", 'charity-is-hope') ),
					"class" => "",
					"value" => array(esc_html__('Create gap', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
				),
				array(
					"param_name" => "dir",
					"heading" => esc_html__("Direction", 'charity-is-hope'),
					"description" => wp_kses_data( __("Scroll direction for the parallax background", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => array(
							esc_html__('Up', 'charity-is-hope') => 'up',
							esc_html__('Down', 'charity-is-hope') => 'down'
						),
					"type" => "dropdown"
				),
				array(
					"param_name" => "speed",
					"heading" => esc_html__("Speed", 'charity-is-hope'),
					"description" => wp_kses_data( __("Parallax background motion speed (from 0.0 to 1.0)", 'charity-is-hope') ),
					"class" => "",
					"value" => "0.3",
					"type" => "textfield"
				),
				...
				array(
					...
					"description" => wp_kses_data( __("Select color for text object inside parallax block", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					"param_name" => "bg_color",
					"heading" => esc_html__("Backgroud color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select color for parallax background", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					...
					"description" => wp_kses_data( __("Select or upload image or write URL from other site for the parallax background", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "attach_image"
				),
				array(
					...
					"heading" => esc_html__("Image X position", 'charity-is-hope'),
					"description" => wp_kses_data( __("Parallax background X position (in percents)", 'charity-is-hope') ),
					"class" => "",
					"value" => "50%",
					"type" => "textfield"
				),
				array(
					"param_name" => "bg_video",
					"heading" => esc_html__("Video background", 'charity-is-hope'),
					"description" => wp_kses_data( __("Paste URL for video file to show it as parallax background", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"heading" => esc_html__("Video ratio", 'charity-is-hope'),
					"description" => wp_kses_data( __("Specify ratio of the video background. For example: 16:9 (default), 4:3, etc.", 'charity-is-hope') ),
					"class" => "",
					"value" => "16:9",
					"type" => "textfield"
				),
