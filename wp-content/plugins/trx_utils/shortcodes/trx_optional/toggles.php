...
if ( !function_exists( 'charity_is_hope_sc_toggles_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_toggles_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_toggles", array(
			"title" => esc_html__("Toggles", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Toggles items", 'charity-is-hope') ),
			"decorate" => true,
			"container" => false,
			"params" => array(
				"counter" => array(
					"title" => esc_html__("Counter", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Display counter before each toggles title", 'charity-is-hope') ),
					"value" => "off",
					"type" => "switch",
				...
				"icon_closed" => array(
					...
					"desc" => wp_kses_data( __('Select icon for the closed toggles item from Fontello icons set',  'charity-is-hope') ),
					"value" => "",
					"type" => "icons",
				...
				"icon_opened" => array(
					...
					"desc" => wp_kses_data( __('Select icon for the opened toggles item from Fontello icons set',  'charity-is-hope') ),
					"value" => "",
					"type" => "icons",
					"options" => charity_is_hope_get_sc_param('icons')
				),
			...
			"children" => array(
				...
				"title" => esc_html__("Toggles item", 'charity-is-hope'),
				"desc" => wp_kses_data( __("Toggles item", 'charity-is-hope') ),
				"container" => true,
				"params" => array(
					"title" => array(
						"title" => esc_html__("Toggles item title", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Title for current toggles item", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"open" => array(
						"title" => esc_html__("Open on show", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Open current toggles item on show", 'charity-is-hope') ),
						"value" => "no",
						"type" => "switch",
					...
					"_content_" => array(
						"title" => esc_html__("Toggles item content", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Current toggles item content", 'charity-is-hope') ),
						"rows" => 4,
						"value" => "",
						"type" => "textarea"
					),
...
if ( !function_exists( 'charity_is_hope_sc_toggles_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_toggles_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_toggles",
			"name" => esc_html__("Toggles", 'charity-is-hope'),
			"description" => wp_kses_data( __("Toggles items", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses_data( __("Display counter before each toggles title", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					...
					"description" => wp_kses_data( __("Select icon for the closed toggles item from Fontello icons set", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					...
					"description" => wp_kses_data( __("Select icon for the opened toggles item from Fontello icons set", 'charity-is-hope') ),
					"class" => "",
					"value" => charity_is_hope_get_sc_param('icons'),
					"type" => "dropdown"
				),
			...
			'default_content' => '
				[trx_toggles_item title="' . esc_html__( 'Item 1 title', 'charity-is-hope' ) . '"][/trx_toggles_item]
				[trx_toggles_item title="' . esc_html__( 'Item 2 title', 'charity-is-hope' ) . '"][/trx_toggles_item]
			',
			"custom_markup" => '
		...
		vc_map( array(
			...
			"name" => esc_html__("Toggles item", 'charity-is-hope'),
			"description" => wp_kses_data( __("Single toggles item", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses_data( __("Title for current toggles item", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "open",
					"heading" => esc_html__("Open on show", 'charity-is-hope'),
					"description" => wp_kses_data( __("Open current toggle item on show", 'charity-is-hope') ),
					"class" => "",
