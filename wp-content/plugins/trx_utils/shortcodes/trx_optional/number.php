...
if ( !function_exists( 'charity_is_hope_sc_number_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_number_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_number", array(
			...
			"desc" => wp_kses_data( __("Insert number or any word as set separate characters", 'charity-is-hope') ),
			"decorate" => false,
			"container" => false,
			"params" => array(
				"value" => array(
					"title" => esc_html__("Value", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Number or any word", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"align" => array(
...
if ( !function_exists( 'charity_is_hope_sc_number_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_number_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_number",
			"name" => esc_html__("Number", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert number or any word as set of separated characters", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses_data( __("Number or any word to separate", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
