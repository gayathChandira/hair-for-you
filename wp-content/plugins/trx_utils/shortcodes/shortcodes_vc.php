...
if ( !function_exists( 'charity_is_hope_vc_width' ) ) {
	function charity_is_hope_vc_width($w='') {
		return array(
			"param_name" => "width",
			"heading" => esc_html__("Width", 'charity-is-hope'),
			"description" => wp_kses_data( __("Width of the element", 'charity-is-hope') ),
			"group" => esc_html__('Size &amp; Margins', 'charity-is-hope'),
			"value" => $w,
			"type" => "textfield"
		);
	}
...
if ( !function_exists( 'charity_is_hope_vc_height' ) ) {
	function charity_is_hope_vc_height($h='') {
		return array(
			"param_name" => "height",
			"heading" => esc_html__("Height", 'charity-is-hope'),
			"description" => wp_kses_data( __("Height of the element", 'charity-is-hope') ),
			"group" => esc_html__('Size &amp; Margins', 'charity-is-hope'),
			"value" => $h,
			"type" => "textfield"
		);
...
if ( !function_exists( 'charity_is_hope_shortcodes_vc_theme_setup' ) ) {
	...
	function charity_is_hope_shortcodes_vc_theme_setup() {
		...
		vc_add_param("vc_row", array(
					...
					"group" => esc_html__('Color scheme', 'charity-is-hope'),
					"class" => "",
		...
		vc_add_param("vc_row", array(
					"param_name" => "inverse",
					"heading" => esc_html__("Inverse colors", 'charity-is-hope'),
					"description" => wp_kses_data( __("Inverse all colors of this block", 'charity-is-hope') ),
					"group" => esc_html__('Color scheme', 'charity-is-hope'),
					"class" => "",
					"std" => "no",
					"value" => array(esc_html__('Inverse colors', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
		));
		...
		if (charity_is_hope_shortcodes_is_used() && class_exists('CHARITY_IS_HOPE_VC_ShortCodeSingle')) {
			...
			charity_is_hope_storage_set('vc_params', array(
				...
				'category' => esc_html__("Charity Is Hope shortcodes", 'charity-is-hope'),
			
				// Current element id
				'id' => array(
					"param_name" => "id",
					"heading" => esc_html__("Element ID", 'charity-is-hope'),
					"description" => wp_kses_data( __("ID for the element", 'charity-is-hope') ),
					"group" => esc_html__('ID &amp; Class', 'charity-is-hope'),
					"value" => "",
					"type" => "textfield"
				),
				...
				'class' => array(
					"param_name" => "class",
					"heading" => esc_html__("Element CSS class", 'charity-is-hope'),
					"description" => wp_kses_data( __("CSS class for the element", 'charity-is-hope') ),
					"group" => esc_html__('ID &amp; Class', 'charity-is-hope'),
					"value" => "",
					"type" => "textfield"
				),
				...
				'animation' => array(
					...
					"heading" => esc_html__("Animation", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select animation while object enter in the visible area of page", 'charity-is-hope') ),
					"group" => esc_html__('ID &amp; Class', 'charity-is-hope'),
					"class" => "",
				...
				'css' => array(
					"param_name" => "css",
					"heading" => esc_html__("CSS styles", 'charity-is-hope'),
					"description" => wp_kses_data( __("Any additional CSS rules (if need)", 'charity-is-hope') ),
					"group" => esc_html__('ID &amp; Class', 'charity-is-hope'),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				'margin_top' => array(
					"param_name" => "top",
					"heading" => esc_html__("Top margin", 'charity-is-hope'),
					"description" => wp_kses_data( __("Margin above this shortcode", 'charity-is-hope') ),
					"group" => esc_html__('Size &amp; Margins', 'charity-is-hope'),
					"std" => "inherit",
				...
				'margin_bottom' => array(
					"param_name" => "bottom",
					"heading" => esc_html__("Bottom margin", 'charity-is-hope'),
					"description" => wp_kses_data( __("Margin below this shortcode", 'charity-is-hope') ),
					"group" => esc_html__('Size &amp; Margins', 'charity-is-hope'),
					"std" => "inherit",
					"value" => array_flip(charity_is_hope_get_sc_param('margins')),
					"type" => "dropdown"
				...
				'margin_left' => array(
					"param_name" => "left",
					"heading" => esc_html__("Left margin", 'charity-is-hope'),
					"description" => wp_kses_data( __("Margin on the left side of this shortcode", 'charity-is-hope') ),
					"group" => esc_html__('Size &amp; Margins', 'charity-is-hope'),
					"std" => "inherit",
					"value" => array_flip(charity_is_hope_get_sc_param('margins')),
					"type" => "dropdown"
				...
				'margin_right' => array(
					"param_name" => "right",
					"heading" => esc_html__("Right margin", 'charity-is-hope'),
					"description" => wp_kses_data( __("Margin on the right side of this shortcode", 'charity-is-hope') ),
					"group" => esc_html__('Size &amp; Margins', 'charity-is-hope'),
					"std" => "inherit",
					"value" => array_flip(charity_is_hope_get_sc_param('margins')),
					"type" => "dropdown"
