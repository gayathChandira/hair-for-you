...
if ( !function_exists( 'charity_is_hope_shortcodes_width' ) ) {
	function charity_is_hope_shortcodes_width($w="") {
		return array(
			"title" => esc_html__("Width", 'charity-is-hope'),
			"divider" => true,
			"value" => $w,
			"type" => "text"
		);
...
if ( !function_exists( 'charity_is_hope_shortcodes_height' ) ) {
	function charity_is_hope_shortcodes_height($h='') {
		return array(
			"title" => esc_html__("Height", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Width and height of the element", 'charity-is-hope') ),
			"value" => $h,
			"type" => "text"
		);
	}
	...
	function charity_is_hope_shortcodes_settings_theme_setup() {
		if (charity_is_hope_shortcodes_is_used()) {
			...
			charity_is_hope_storage_set('sc_params', array(
				...
				// Current element id
				'id' => array(
					"title" => esc_html__("Element ID", 'charity-is-hope'),
					"desc" => wp_kses_data( __("ID for current element", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "text"
				),
				...
				'class' => array(
					"title" => esc_html__("Element CSS class", 'charity-is-hope'),
					"desc" => wp_kses_data( __("CSS class for current element (optional)", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				...
				'css' => array(
					"title" => esc_html__("CSS styles", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Any additional CSS rules (if need)", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				...
				// Switcher choises
				'list_styles' => array(
					'ul'	=> esc_html__('Unordered', 'charity-is-hope'),
					'ol'	=> esc_html__('Ordered', 'charity-is-hope'),
			...
			charity_is_hope_set_sc_param('animation', array(
				"title" => esc_html__("Animation",  'charity-is-hope'),
				"desc" => wp_kses_data( __('Select animation while object enter in the visible area of page',  'charity-is-hope') ),
				"value" => "none",
				"type" => "select",
			...
			charity_is_hope_set_sc_param('top', array(
				"title" => esc_html__("Top margin",  'charity-is-hope'),
				"divider" => true,
				"value" => "inherit",
				"type" => "select",
			...
			charity_is_hope_set_sc_param('bottom', array(
				"title" => esc_html__("Bottom margin",  'charity-is-hope'),
				"value" => "inherit",
				"type" => "select",
				"options" => charity_is_hope_get_sc_param('margins')
				)
			...
			charity_is_hope_set_sc_param('left', array(
				"title" => esc_html__("Left margin",  'charity-is-hope'),
				"value" => "inherit",
				"type" => "select",
				"options" => charity_is_hope_get_sc_param('margins')
				)
			...
			charity_is_hope_set_sc_param('right', array(
				"title" => esc_html__("Right margin",  'charity-is-hope'),
				"desc" => wp_kses_data( __("Margins around this shortcode", 'charity-is-hope') ),
				"value" => "inherit",
				"type" => "select",
				"options" => charity_is_hope_get_sc_param('margins')
				)
