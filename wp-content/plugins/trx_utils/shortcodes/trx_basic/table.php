...
if ( !function_exists( 'charity_is_hope_sc_table_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_table_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_table", array(
			"title" => esc_html__("Table", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Insert a table into post (page). ", 'charity-is-hope') ),
			"decorate" => true,
			"container" => true,
			"params" => array(
				"align" => array(
					"title" => esc_html__("Content alignment", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select alignment for each table cell", 'charity-is-hope') ),
					"value" => "none",
					"type" => "checklist",
					"dir" => "horizontal",
				...
				"_content_" => array(
					"title" => esc_html__("Table content", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Content, created with any table-generator", 'charity-is-hope') ),
					"divider" => true,
					"rows" => 8,
...
if ( !function_exists( 'charity_is_hope_sc_table_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_table_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_table",
			"name" => esc_html__("Table", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert a table", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "align",
					"heading" => esc_html__("Cells content alignment", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select alignment for each table cell", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					"param_name" => "content",
					"heading" => esc_html__("Table content", 'charity-is-hope'),
					"description" => wp_kses_data( __("Content, created with any table-generator", 'charity-is-hope') ),
					"class" => "",
					"value" => esc_html__("Paste here table content, generated on one of many public internet resources, for example: http://www.impressivewebs.com/html-table-code-generator/ or http://html-tables.com/", 'charity-is-hope'),
					"type" => "textarea_html"
				),
