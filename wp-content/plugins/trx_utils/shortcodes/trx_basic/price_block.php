...
if ( !function_exists( 'charity_is_hope_sc_price_block_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_price_block_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_price_block", array(
			"title" => esc_html__("Price block", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Insert price block with title, price and description", 'charity-is-hope') ),
			"decorate" => false,
			"container" => true,
			"params" => array(
				"style" => array(
					"title" => esc_html__("Block style", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select style for this price block", 'charity-is-hope') ),
					"value" => 1,
				...
				"title" => array(
					...
					"desc" => wp_kses_data( __("Block title", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"link" => array(
					"title" => esc_html__("Link URL", 'charity-is-hope'),
					"desc" => wp_kses_data( __("URL for link from button (at bottom of the block)", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"link_text" => array(
					"title" => esc_html__("Link text", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Text (caption) for the link button (at bottom of the block). If empty - button not showed", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"icon" => array(
					"title" => esc_html__("Icon",  'charity-is-hope'),
					"desc" => wp_kses_data( __('Select icon from Fontello icons set (placed before/instead price)',  'charity-is-hope') ),
					"value" => "",
					"type" => "icons",
					"options" => charity_is_hope_get_sc_param('icons')
				),
				"money" => array(
					"title" => esc_html__("Money", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Money value (dot or comma separated)", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "text"
				),
				"currency" => array(
					...
					"desc" => wp_kses_data( __("Currency character", 'charity-is-hope') ),
					"value" => "$",
					"type" => "text"
				),
				"period" => array(
					"title" => esc_html__("Period", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Period text (if need). For example: monthly, daily, etc.", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"scheme" => array(
				...
				"align" => array(
					...
					"desc" => wp_kses_data( __("Align price to left or right side", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "checklist",
					"dir" => "horizontal",
				...
				"_content_" => array(
					...
					"desc" => wp_kses_data( __("Description for this price block", 'charity-is-hope') ),
					"divider" => true,
					"rows" => 4,
					"value" => "",
					"type" => "textarea"
...
if ( !function_exists( 'charity_is_hope_sc_price_block_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_price_block_reg_shortcodes_vc() {
		...
		vc_map( array(
			...
			"name" => esc_html__("Price block", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert price block with title, price and description", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "style",
					"heading" => esc_html__("Block style", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select style of this price block", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"std" => 1,
				...
				array(
					...
					"description" => wp_kses_data( __("Block title", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses_data( __("URL for link from button (at bottom of the block)", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"heading" => esc_html__("Link text", 'charity-is-hope'),
					"description" => wp_kses_data( __("Text (caption) for the link button (at bottom of the block). If empty - button not showed", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"description" => wp_kses_data( __("Select icon from Fontello icons set (placed before/instead price)", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					"param_name" => "money",
					"heading" => esc_html__("Money", 'charity-is-hope'),
					"description" => wp_kses_data( __("Money value (dot or comma separated)", 'charity-is-hope') ),
					"admin_label" => true,
					"group" => esc_html__('Money', 'charity-is-hope'),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					"param_name" => "currency",
					"heading" => esc_html__("Currency symbol", 'charity-is-hope'),
					"description" => wp_kses_data( __("Currency character", 'charity-is-hope') ),
					"admin_label" => true,
					"group" => esc_html__('Money', 'charity-is-hope'),
					"class" => "",
					"value" => "$",
				...
				array(
					"param_name" => "period",
					"heading" => esc_html__("Period", 'charity-is-hope'),
					"description" => wp_kses_data( __("Period text (if need). For example: monthly, daily, etc.", 'charity-is-hope') ),
					"admin_label" => true,
					"group" => esc_html__('Money', 'charity-is-hope'),
					"class" => "",
					"value" => "",
				...
				array(
					...
					"description" => wp_kses_data( __("Align price to left or right side", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					...
					"description" => wp_kses_data( __("Description for this price block", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textarea_html"
				),
