...
if ( !function_exists( 'charity_is_hope_sc_socials_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_socials_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_socials", array(
			"title" => esc_html__("Social icons", 'charity-is-hope'),
			"desc" => wp_kses_data( __("List of social icons (with hovers)", 'charity-is-hope') ),
			"decorate" => true,
			"container" => false,
			"params" => array(
				"type" => array(
					"title" => esc_html__("Icon's type", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Type of the icons - images or font icons", 'charity-is-hope') ),
				...
				"size" => array(
					"title" => esc_html__("Icon's size", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Size of the icons", 'charity-is-hope') ),
					"value" => "small",
					"options" => charity_is_hope_get_sc_param('sizes'),
					"type" => "checklist"
				), 
				"shape" => array(
					"title" => esc_html__("Icon's shape", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Shape of the icons", 'charity-is-hope') ),
					"value" => "square",
					"options" => charity_is_hope_get_sc_param('shapes'),
					"type" => "checklist"
				), 
				"socials" => array(
					"title" => esc_html__("Manual socials list", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Custom list of social networks. For example: twitter=http://twitter.com/my_profile|facebook=http://facebook.com/my_profile. If empty - use socials from Theme options.", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "text"
				),
				"custom" => array(
					"title" => esc_html__("Custom socials", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Make custom icons from inner shortcodes (prepare it on tabs)", 'charity-is-hope') ),
					"divider" => true,
					"value" => "no",
			...
			"children" => array(
				...
				"title" => esc_html__("Custom social item", 'charity-is-hope'),
				"desc" => wp_kses_data( __("Custom social item: name, profile url and icon url", 'charity-is-hope') ),
				"decorate" => false,
				"container" => false,
				"params" => array(
					"name" => array(
						"title" => esc_html__("Social name", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Name (slug) of the social network (twitter, facebook, linkedin, etc.)", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"url" => array(
						"title" => esc_html__("Your profile URL", 'charity-is-hope'),
						"desc" => wp_kses_data( __("URL of your profile in specified social network", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"icon" => array(
						"title" => esc_html__("URL (source) for icon file", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Select or upload image or write URL from other site for the current social icon", 'charity-is-hope') ),
						"readonly" => false,
						"value" => "",
						"type" => "media"
					)
...
if ( !function_exists( 'charity_is_hope_sc_socials_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_socials_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_socials",
			"name" => esc_html__("Social icons", 'charity-is-hope'),
			"description" => wp_kses_data( __("Custom social icons", 'charity-is-hope') ),
			...
			"params" => array_merge(array(
				array(
					...
					"description" => wp_kses_data( __("Type of the icons - images or font icons", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					"param_name" => "size",
					"heading" => esc_html__("Icon's size", 'charity-is-hope'),
					"description" => wp_kses_data( __("Size of the icons", 'charity-is-hope') ),
					"class" => "",
					"std" => "small",
				...
				array(
					"param_name" => "shape",
					"heading" => esc_html__("Icon's shape", 'charity-is-hope'),
					"description" => wp_kses_data( __("Shape of the icons", 'charity-is-hope') ),
					"class" => "",
					"std" => "square",
				...
				array(
					"param_name" => "socials",
					"heading" => esc_html__("Manual socials list", 'charity-is-hope'),
					"description" => wp_kses_data( __("Custom list of social networks. For example: twitter=http://twitter.com/my_profile|facebook=http://facebook.com/my_profile. If empty - use socials from Theme options.", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					"param_name" => "custom",
					"heading" => esc_html__("Custom socials", 'charity-is-hope'),
					"description" => wp_kses_data( __("Make custom icons from inner shortcodes (prepare it on tabs)", 'charity-is-hope') ),
					"class" => "",
					"value" => array(esc_html__('Custom socials', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
				),
		...
		vc_map( array(
			...
			"name" => esc_html__("Custom social item", 'charity-is-hope'),
			"description" => wp_kses_data( __("Custom social item: name, profile url and icon url", 'charity-is-hope') ),
			"show_settings_on_create" => true,
			"content_element" => true,
			"is_container" => false,
			...
			"params" => array(
				array(
					"param_name" => "name",
					"heading" => esc_html__("Social name", 'charity-is-hope'),
					"description" => wp_kses_data( __("Name (slug) of the social network (twitter, facebook, linkedin, etc.)", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					"param_name" => "url",
					"heading" => esc_html__("Your profile URL", 'charity-is-hope'),
					"description" => wp_kses_data( __("URL of your profile in specified social network", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					"param_name" => "icon",
					"heading" => esc_html__("URL (source) for icon file", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select or upload image or write URL from other site for the current social icon", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "attach_image"
