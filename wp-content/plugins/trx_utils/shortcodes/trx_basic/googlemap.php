...
if ( !function_exists( 'charity_is_hope_sc_googlemap_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_googlemap_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_googlemap", array(
			"title" => esc_html__("Google map", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Insert Google map with specified markers", 'charity-is-hope') ),
			"decorate" => false,
			"container" => true,
			"params" => array(
				"zoom" => array(
					"title" => esc_html__("Zoom", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Map zoom factor", 'charity-is-hope') ),
					"divider" => true,
					"value" => 16,
					"min" => 1,
					"max" => 20,
				...
				"style" => array(
					"title" => esc_html__("Map style", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select map style", 'charity-is-hope') ),
					"value" => "default",
					"type" => "checklist",
			...
			"children" => array(
				...
				"desc" => wp_kses_data( __("Google map marker", 'charity-is-hope') ),
				"decorate" => false,
				"container" => true,
				"params" => array(
					"address" => array(
						"title" => esc_html__("Address", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Address of this marker", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"latlng" => array(
						"title" => esc_html__("Latitude and Longitude", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Comma separated marker's coorditanes (instead Address)", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"point" => array(
						"title" => esc_html__("URL for marker image file", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Select or upload image or write URL from other site for this marker. If empty - use default marker", 'charity-is-hope') ),
						"readonly" => false,
						"value" => "",
						"type" => "media"
					),
					"title" => array(
						...
						"desc" => wp_kses_data( __("Title for this marker", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"_content_" => array(
						"title" => esc_html__("Description", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Description for this marker", 'charity-is-hope') ),
						"rows" => 4,
						"value" => "",
						"type" => "textarea"
					),
...
if ( !function_exists( 'charity_is_hope_sc_googlemap_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_googlemap_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_googlemap",
			"name" => esc_html__("Google map", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert Google map with desired address or coordinates", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "zoom",
					"heading" => esc_html__("Zoom", 'charity-is-hope'),
					"description" => wp_kses_data( __("Map zoom factor", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "16",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses_data( __("Map custom style", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
		...
		vc_map( array(
			...
			"name" => esc_html__("Googlemap marker", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert new marker into Google map", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "address",
					"heading" => esc_html__("Address", 'charity-is-hope'),
					"description" => wp_kses_data( __("Address of this marker", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "latlng",
					"heading" => esc_html__("Latitude and Longitude", 'charity-is-hope'),
					"description" => wp_kses_data( __("Comma separated marker's coorditanes (instead Address)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses_data( __("Title for this marker", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "point",
					"heading" => esc_html__("URL for marker image file", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select or upload image or write URL from other site for this marker. If empty - use default marker", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "attach_image"
				),
