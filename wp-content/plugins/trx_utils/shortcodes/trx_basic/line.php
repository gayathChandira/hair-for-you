...
if ( !function_exists( 'charity_is_hope_sc_line_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_line_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_line", array(
			"title" => esc_html__("Line", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Insert Line into your post (page)", 'charity-is-hope') ),
			"decorate" => false,
			"container" => false,
			"params" => array(
				"style" => array(
					"title" => esc_html__("Style", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Line style", 'charity-is-hope') ),
					"value" => "solid",
					"dir" => "horizontal",
				...
				"image" => array(
					"title" => esc_html__("Image as separator", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select or upload image or write URL from other site to use it as separator", 'charity-is-hope') ),
					"readonly" => false,
					"dependency" => array(
						'style' => array('image')
					),
				...
				"repeat" => array(
					"title" => esc_html__("Repeat image", 'charity-is-hope'),
					"desc" => wp_kses_data( __("To repeat an image or to show single picture", 'charity-is-hope') ),
					"dependency" => array(
						'style' => array('image')
					),
					"value" => "no",
				...
				"color" => array(
					...
					"desc" => wp_kses_data( __("Line color", 'charity-is-hope') ),
					"dependency" => array(
				...
				"title" => array(
					...
					"desc" => wp_kses_data( __("Title that is going to be placed in the center of the line (if not empty)", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"position" => array(
					"title" => esc_html__("Title position", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Title position", 'charity-is-hope') ),
					"dependency" => array(
...
if ( !function_exists( 'charity_is_hope_sc_line_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_line_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_line",
			"name" => esc_html__("Line", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert line (delimiter)", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses_data( __("Line style", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"std" => "solid",
				...
				array(
					"param_name" => "image",
					"heading" => esc_html__("Image as separator", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select or upload image or write URL from other site to use it as separator", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'style',
						'value' => array('image')
					),
				...
				array(
					"param_name" => "repeat",
					"heading" => esc_html__("Repeat image", 'charity-is-hope'),
					"description" => wp_kses_data( __("To repeat an image or to show single picture", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'style',
						'value' => array('image')
					),
				...
				array(
					"param_name" => "color",
					"heading" => esc_html__("Line color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Line color", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'style',
				...
				array(
					...
					"description" => wp_kses_data( __("Title that is going to be placed in the center of the line (if not empty)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "position",
					"heading" => esc_html__("Title position", 'charity-is-hope'),
					"description" => wp_kses_data( __("Title position", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"std" => "center center",
