...
if ( !function_exists( 'charity_is_hope_sc_hide_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_hide_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_hide", array(
			"title" => esc_html__("Hide/Show any block", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Hide or Show any block with desired CSS-selector", 'charity-is-hope') ),
			"decorate" => false,
			"container" => false,
			"params" => array(
				"selector" => array(
					"title" => esc_html__("Selector", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Any block's CSS-selector", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"hide" => array(
					"title" => esc_html__("Hide or Show", 'charity-is-hope'),
					"desc" => wp_kses_data( __("New state for the block: hide or show", 'charity-is-hope') ),
					"value" => "yes",
					"size" => "small",
