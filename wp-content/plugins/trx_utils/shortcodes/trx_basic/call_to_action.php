...
if ( !function_exists( 'charity_is_hope_sc_call_to_action_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_call_to_action_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_call_to_action", array(
			"title" => esc_html__("Call to action", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Insert call to action block in your page (post)", 'charity-is-hope') ),
			"decorate" => true,
			"container" => true,
			"params" => array(
				"title" => array(
				...
				"align" => array(
					...
					"desc" => wp_kses_data( __("Alignment elements in the block(style1)", 'charity-is-hope') ),
					"value" => "",
					"type" => "checklist",
					"dir" => "horizontal",
				...
				"accent" => array(
					"title" => esc_html__("Accented", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Fill entire block with links color from current color scheme", 'charity-is-hope') ),
					"divider" => true,
					"value" => "no",
					"type" => "switch",
				...
				"custom" => array(
					...
					"desc" => wp_kses_data( __("Allow get featured image or video from inner shortcodes (custom) or get it from shortcode parameters below", 'charity-is-hope') ),
					"divider" => true,
					"value" => "no",
					"type" => "switch",
					"options" => charity_is_hope_get_sc_param('yes_no')
				...
				"image" => array(
					...
					"desc" => wp_kses_data( __("Select or upload image or write URL from other site to include image into this block", 'charity-is-hope') ),
					"divider" => true,
					"readonly" => false,
					"value" => "",
					"type" => "media"
...
if ( !function_exists( 'charity_is_hope_sc_call_to_action_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_call_to_action_reg_shortcodes_vc() {
		...
		vc_map( array(
			...
			"name" => esc_html__("Call to Action", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert call to action block in your page (post)", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "style",
					"heading" => esc_html__("Block's style", 'charity-is-hope'),
				...
				array(
					...
					"description" => wp_kses_data( __("Select block alignment (style 1)", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					"param_name" => "accent",
					"heading" => esc_html__("Accent", 'charity-is-hope'),
					"description" => wp_kses_data( __("Fill entire block with links color from current color scheme", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					...
					"description" => wp_kses_data( __("Allow get featured image or video from inner shortcodes (custom) or get it from shortcode parameters below", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					...
					"description" => wp_kses_data( __("Image to display inside block", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'custom',
						'is_empty' => true
					),
