...
if ( !function_exists( 'charity_is_hope_sc_twitter_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_twitter_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_twitter", array(
			"title" => esc_html__("Twitter", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Insert twitter feed into post (page)", 'charity-is-hope') ),
			"decorate" => false,
			"container" => false,
			"params" => array(
				"user" => array(
					"title" => esc_html__("Twitter Username", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Your username in the twitter account. If empty - get it from Theme Options.", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"consumer_key" => array(
					"title" => esc_html__("Consumer Key", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Consumer Key from the twitter account", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"consumer_secret" => array(
					"title" => esc_html__("Consumer Secret", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Consumer Secret from the twitter account", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"token_key" => array(
					"title" => esc_html__("Token Key", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Token Key from the twitter account", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"token_secret" => array(
					"title" => esc_html__("Token Secret", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Token Secret from the twitter account", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"count" => array(
					"title" => esc_html__("Tweets number", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Tweets number to show", 'charity-is-hope') ),
					"divider" => true,
					"value" => 3,
					"max" => 20,
					"min" => 1,
				...
				"controls" => array(
					"title" => esc_html__("Show arrows", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Show control buttons", 'charity-is-hope') ),
					"value" => "yes",
					"type" => "switch",
					"options" => charity_is_hope_get_sc_param('yes_no')
				),
				"interval" => array(
					"title" => esc_html__("Tweets change interval", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Tweets change interval (in milliseconds: 1000ms = 1s)", 'charity-is-hope') ),
					"value" => 7000,
					"step" => 500,
					"min" => 0,
					"type" => "spinner"
				...
				"align" => array(
					...
					"desc" => wp_kses_data( __("Alignment of the tweets block", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "checklist",
					"dir" => "horizontal",
...
if ( !function_exists( 'charity_is_hope_sc_twitter_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_twitter_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_twitter",
			"name" => esc_html__("Twitter", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert twitter feed into post (page)", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "user",
					"heading" => esc_html__("Twitter Username", 'charity-is-hope'),
					"description" => wp_kses_data( __("Your username in the twitter account. If empty - get it from Theme Options.", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"heading" => esc_html__("Consumer Key", 'charity-is-hope'),
					"description" => wp_kses_data( __("Consumer Key from the twitter account", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"heading" => esc_html__("Consumer Secret", 'charity-is-hope'),
					"description" => wp_kses_data( __("Consumer Secret from the twitter account", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"heading" => esc_html__("Token Key", 'charity-is-hope'),
					"description" => wp_kses_data( __("Token Key from the twitter account", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"heading" => esc_html__("Token Secret", 'charity-is-hope'),
					"description" => wp_kses_data( __("Token Secret from the twitter account", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					"param_name" => "count",
					"heading" => esc_html__("Tweets number", 'charity-is-hope'),
					"description" => wp_kses_data( __("Number tweets to show", 'charity-is-hope') ),
					"class" => "",
					"divider" => true,
					"value" => 3,
					"type" => "textfield"
				...
				array(
					"param_name" => "controls",
					"heading" => esc_html__("Show arrows", 'charity-is-hope'),
					"description" => wp_kses_data( __("Show control buttons", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					"param_name" => "interval",
					"heading" => esc_html__("Tweets change interval", 'charity-is-hope'),
					"description" => wp_kses_data( __("Tweets change interval (in milliseconds: 1000ms = 1s)", 'charity-is-hope') ),
					"class" => "",
					"value" => "7000",
					"type" => "textfield"
				),
				array(
					...
					"description" => wp_kses_data( __("Alignment of the tweets block", 'charity-is-hope') ),
					"class" => "",
