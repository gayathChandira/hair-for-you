...
if ( !function_exists( 'charity_is_hope_sc_chat_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_chat_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_chat", array(
			"title" => esc_html__("Chat", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Chat message", 'charity-is-hope') ),
			"decorate" => true,
			"container" => true,
			"params" => array(
				"title" => array(
					"title" => esc_html__("Item title", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Chat item title", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"photo" => array(
					"title" => esc_html__("Item photo", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select or upload image or write URL from other site for the item photo (avatar)", 'charity-is-hope') ),
					"readonly" => false,
					"value" => "",
					"type" => "media"
				),
				"link" => array(
					"title" => esc_html__("Item link", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Chat item link", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"_content_" => array(
					"title" => esc_html__("Chat item content", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Current chat item content", 'charity-is-hope') ),
					"rows" => 4,
					"value" => "",
					"type" => "textarea"
				),
...
if ( !function_exists( 'charity_is_hope_sc_chat_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_chat_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_chat",
			"name" => esc_html__("Chat", 'charity-is-hope'),
			"description" => wp_kses_data( __("Chat message", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "title",
					"heading" => esc_html__("Item title", 'charity-is-hope'),
					"description" => wp_kses_data( __("Title for current chat item", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "photo",
					"heading" => esc_html__("Item photo", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select or upload image or write URL from other site for the item photo (avatar)", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "attach_image"
				),
				array(
					...
					"description" => wp_kses_data( __("URL for the link on chat title click", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
