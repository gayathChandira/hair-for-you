...
if ( !function_exists( 'charity_is_hope_sc_columns_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_columns_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_columns", array(
			...
			"desc" => wp_kses_data( __("Insert up to 5 columns in your page (post)", 'charity-is-hope') ),
			"decorate" => true,
			"container" => false,
			"params" => array(
				"fluid" => array(
					"title" => esc_html__("Fluid columns", 'charity-is-hope'),
					"desc" => wp_kses_data( __("To squeeze the columns when reducing the size of the window (fluid=yes) or to rebuild them (fluid=no)", 'charity-is-hope') ),
					"value" => "no",
					"type" => "switch",
					"options" => charity_is_hope_get_sc_param('yes_no')
				), 
				"margins" => array(
					"title" => esc_html__("Margins between columns", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Add margins between columns", 'charity-is-hope') ),
					"value" => "yes",
					"type" => "switch",
					"options" => charity_is_hope_get_sc_param('yes_no')
				), 
			...
			"children" => array(
				...
				"title" => esc_html__("Column", 'charity-is-hope'),
				"desc" => wp_kses_data( __("Column item", 'charity-is-hope') ),
				"container" => true,
				"params" => array(
					"span" => array(
						"title" => esc_html__("Merge columns", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Count merged columns from current", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"align" => array(
						"title" => esc_html__("Alignment", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Alignment text in the column", 'charity-is-hope') ),
						"value" => "",
						"type" => "checklist",
						"dir" => "horizontal",
					...
					"color" => array(
						...
						"desc" => wp_kses_data( __("Any color for objects in this column", 'charity-is-hope') ),
						"value" => "",
						"type" => "color"
					),
					"bg_color" => array(
						"title" => esc_html__("Background color", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Any background color for this column", 'charity-is-hope') ),
						"value" => "",
						"type" => "color"
					),
					"bg_image" => array(
						"title" => esc_html__("URL for background image file", 'charity-is-hope'),
					...
					"bg_tile" => array(
						...
						"desc" => wp_kses_data( __("Do you want tile background image or image cover whole column?", 'charity-is-hope') ),
						"value" => "no",
						"dependency" => array(
					...
					"_content_" => array(
						"title" => esc_html__("Column item content", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Current column item content", 'charity-is-hope') ),
						"divider" => true,
						"rows" => 4,
						"value" => "",
						"type" => "textarea"
...
if ( !function_exists( 'charity_is_hope_sc_columns_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_columns_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_columns",
			"name" => esc_html__("Columns", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert columns with margins", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses_data( __("Number of the columns in the container.", 'charity-is-hope') ),
					"admin_label" => true,
					"value" => "2",
					"type" => "textfield"
				),
				array(
					"param_name" => "fluid",
					"heading" => esc_html__("Fluid columns", 'charity-is-hope'),
					"description" => wp_kses_data( __("To squeeze the columns when reducing the size of the window (fluid=yes) or to rebuild them (fluid=no)", 'charity-is-hope') ),
					"value" => array(esc_html__('Fluid columns', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
				),
				array(
					"param_name" => "equalheight",
					"heading" => esc_html__("Equal height", 'charity-is-hope'),
					"description" => wp_kses_data( __("Make equal height for all columns in the row", 'charity-is-hope') ),
					"value" => array("Equal height" => "yes" ),
					"type" => "checkbox"
				),
				array(
					"param_name" => "margins",
					"heading" => esc_html__("Margins between columns", 'charity-is-hope'),
					"description" => wp_kses_data( __("Add margins between columns", 'charity-is-hope') ),
					"std" => "yes",
					"value" => array(esc_html__('Disable margins between columns', 'charity-is-hope') => 'no'),
					"type" => "checkbox"
				),
		...
		vc_map( array(
			...
			"name" => esc_html__("Column", 'charity-is-hope'),
			"description" => wp_kses_data( __("Column item", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "span",
					"heading" => esc_html__("Merge columns", 'charity-is-hope'),
					"description" => wp_kses_data( __("Count merged columns from current", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses_data( __("Alignment text in the column", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					...
					"description" => wp_kses_data( __("Any color for objects in this column", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					...
					"description" => wp_kses_data( __("Any background color for this column", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					"param_name" => "bg_image",
					"heading" => esc_html__("URL for background image file", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select or upload image or write URL from other site for the background", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "attach_image"
				),
				array(
					...
					"description" => wp_kses_data( __("Do you want tile background image or image cover whole column?", 'charity-is-hope') ),
					"class" => "",
					'dependency' => array(
						'element' => 'bg_image',
						'not_empty' => true
