...
if ( !function_exists( 'charity_is_hope_sc_slider_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_slider_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_slider", array(
			...
			"desc" => wp_kses_data( __("Insert slider into your post (page)", 'charity-is-hope') ),
			"decorate" => true,
			"container" => false,
			"params" => array_merge(array(
				"engine" => array(
					"title" => esc_html__("Slider engine", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select engine for slider. Attention! Swiper is built-in engine, all other engines appears only if corresponding plugings are installed", 'charity-is-hope') ),
					"value" => "swiper",
					"type" => "checklist",
					"options" => charity_is_hope_get_sc_param('sliders')
				),
				"align" => array(
					"title" => esc_html__("Float slider", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Float slider to left or right side", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "checklist",
					"dir" => "horizontal",
				...
				"custom" => array(
					"title" => esc_html__("Custom slides", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Make custom slides from inner shortcodes (prepare it on tabs) or prepare slides from posts thumbnails", 'charity-is-hope') ),
					"divider" => true,
					"value" => "no",
					"type" => "switch",
				...
				"alias" => array(
					"title" => esc_html__("Revolution slider alias", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select Revolution slider to display", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('revo')
					),
					"divider" => true,
				...
				"cat" => array(
					"title" => esc_html__("Swiper: Category list", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select category to show post's images. If empty - select posts from any category or from IDs list", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"divider" => true,
					...
					"style" => "list",
					"multiple" => true,
					"options" => charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), charity_is_hope_get_sc_param('categories'))
				),
				"count" => array(
					"title" => esc_html__("Swiper: Number of posts", 'charity-is-hope'),
					"desc" => wp_kses_data( __("How many posts will be displayed? If used IDs - this parameter ignored.", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => 3,
				...
				"offset" => array(
					"title" => esc_html__("Swiper: Offset before select posts", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Skip posts before select next part.", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => 0,
				...
				"orderby" => array(
					"title" => esc_html__("Swiper: Post order by", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select desired posts sorting method", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => "date",
				...
				"order" => array(
					"title" => esc_html__("Swiper: Post order", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select desired posts order", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => "desc",
				...
				"ids" => array(
					"title" => esc_html__("Swiper: Post IDs list", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Comma separated list of posts ID. If set - parameters above are ignored!", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => "",
				...
				"controls" => array(
					"title" => esc_html__("Swiper: Show slider controls", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Show arrows inside slider", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"divider" => true,
				...
				"pagination" => array(
					"title" => esc_html__("Swiper: Show slider pagination", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Show bullets for switch slides", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => "no",
					...
					"options" => array(
						...
						'full' => esc_html__('Side Titles', 'charity-is-hope'),
						'over' => esc_html__('Over Titles', 'charity-is-hope')
					)
				),
				"titles" => array(
					"title" => esc_html__("Swiper: Show titles section", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Show section with post's title and short post's description", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"divider" => true,
					...
					"type" => "checklist",
					"options" => array(
						"no"    => esc_html__('Not show', 'charity-is-hope'),
						"slide" => esc_html__('Show/Hide info', 'charity-is-hope'),
						"fixed" => esc_html__('Fixed info', 'charity-is-hope')
					)
				),
				"descriptions" => array(
					"title" => esc_html__("Swiper: Post descriptions", 'charity-is-hope'),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"desc" => wp_kses_data( __("Show post's excerpt max length (characters)", 'charity-is-hope') ),
					"value" => 0,
					"min" => 0,
					"max" => 1000,
					"step" => 10,
				...
				"links" => array(
					"title" => esc_html__("Swiper: Post's title as link", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Make links from post's titles", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => "yes",
				...
				"crop" => array(
					"title" => esc_html__("Swiper: Crop images", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Crop images in each slide or live it unchanged", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => "yes",
				...
				"autoheight" => array(
					"title" => esc_html__("Swiper: Autoheight", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Change whole slider's height (make it equal current slide's height)", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => "yes",
				...
				"slides_per_view" => array(
					"title" => esc_html__("Swiper: Slides per view", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Slides per view showed in this slider", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => 1,
				...
				"slides_space" => array(
					"title" => esc_html__("Swiper: Space between slides", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Size of space (in px) between slides", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => 0,
				...
				"interval" => array(
					"title" => esc_html__("Swiper: Slides change interval", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Slides change interval (in milliseconds: 1000ms = 1s)", 'charity-is-hope') ),
					"dependency" => array(
						'engine' => array('swiper')
					),
					"value" => 5000,
			...
			"children" => array(
				...
				"title" => esc_html__("Slide", 'charity-is-hope'),
				"desc" => wp_kses_data( __("Slider item", 'charity-is-hope') ),
				"container" => false,
				"params" => array(
					"src" => array(
						"title" => esc_html__("URL (source) for image file", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Select or upload image or write URL from other site for the current slide", 'charity-is-hope') ),
						"readonly" => false,
						"value" => "",
						"type" => "media"
					),
...
if ( !function_exists( 'charity_is_hope_sc_slider_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_slider_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_slider",
			"name" => esc_html__("Slider", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert slider", 'charity-is-hope') ),
			...
			"params" => array_merge(array(
				array(
					"param_name" => "engine",
					"heading" => esc_html__("Engine", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select engine for slider. Attention! Swiper is built-in engine, all other engines appears only if corresponding plugings are installed", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					"param_name" => "align",
					"heading" => esc_html__("Float slider", 'charity-is-hope'),
					"description" => wp_kses_data( __("Float slider to left or right side", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					"param_name" => "custom",
					"heading" => esc_html__("Custom slides", 'charity-is-hope'),
					"description" => wp_kses_data( __("Make custom slides from inner shortcodes (prepare it on tabs) or prepare slides from posts thumbnails", 'charity-is-hope') ),
					"class" => "",
					"value" => array(esc_html__('Custom slides', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
				)
				),
				function_exists('charity_is_hope_exists_revslider') && charity_is_hope_exists_revslider() ? array(
				array(
					"param_name" => "alias",
					"heading" => esc_html__("Revolution slider alias", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select Revolution slider to display", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					'dependency' => array(
						'element' => 'engine',
					...
					"value" => array_flip(charity_is_hope_array_merge(array('none' => esc_html__('- Select slider -', 'charity-is-hope')), charity_is_hope_get_sc_param('revo_sliders'))),
					"type" => "dropdown"
				)) : array(), array(
				array(
					"param_name" => "cat",
					"heading" => esc_html__("Categories list", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select category. If empty - show posts from any category or from IDs list", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					),
					"class" => "",
					"value" => array_flip(charity_is_hope_array_merge(array(0 => esc_html__('- Select category -', 'charity-is-hope')), charity_is_hope_get_sc_param('categories'))),
					"type" => "dropdown"
				),
				array(
					"param_name" => "count",
					"heading" => esc_html__("Swiper: Number of posts", 'charity-is-hope'),
					"description" => wp_kses_data( __("How many posts will be displayed? If used IDs - this parameter ignored.", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					),
				...
				array(
					"param_name" => "offset",
					"heading" => esc_html__("Swiper: Offset before select posts", 'charity-is-hope'),
					"description" => wp_kses_data( __("Skip posts before select next part.", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					),
				...
				array(
					"param_name" => "orderby",
					"heading" => esc_html__("Swiper: Post sorting", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select desired posts sorting method", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					),
				...
				array(
					"param_name" => "order",
					"heading" => esc_html__("Swiper: Post order", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select desired posts order", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					),
				...
				array(
					"param_name" => "ids",
					"heading" => esc_html__("Swiper: Post IDs list", 'charity-is-hope'),
					"description" => wp_kses_data( __("Comma separated list of posts ID. If set - parameters above are ignored!", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					),
				...
				array(
					"param_name" => "controls",
					"heading" => esc_html__("Swiper: Show slider controls", 'charity-is-hope'),
					"description" => wp_kses_data( __("Show arrows inside slider", 'charity-is-hope') ),
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					),
					"class" => "",
					"value" => array(esc_html__('Show controls', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
				),
				array(
					"param_name" => "pagination",
					"heading" => esc_html__("Swiper: Show slider pagination", 'charity-is-hope'),
					"description" => wp_kses_data( __("Show bullets or titles to switch slides", 'charity-is-hope') ),
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					...
					"std" => "no",
					"value" => array(
							esc_html__('None', 'charity-is-hope') => 'no',
							esc_html__('Dots', 'charity-is-hope') => 'yes', 
							esc_html__('Side Titles', 'charity-is-hope') => 'full',
							esc_html__('Over Titles', 'charity-is-hope') => 'over'
						),
					"type" => "dropdown"
				),
				array(
					"param_name" => "titles",
					"heading" => esc_html__("Swiper: Show titles section", 'charity-is-hope'),
					"description" => wp_kses_data( __("Show section with post's title and short post's description", 'charity-is-hope') ),
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					...
					"class" => "",
					"value" => array(
							esc_html__('Not show', 'charity-is-hope') => "no",
							esc_html__('Show/Hide info', 'charity-is-hope') => "slide",
							esc_html__('Fixed info', 'charity-is-hope') => "fixed"
					),
					"type" => "dropdown"
				),
				array(
					"param_name" => "descriptions",
					"heading" => esc_html__("Swiper: Post descriptions", 'charity-is-hope'),
					"description" => wp_kses_data( __("Show post's excerpt max length (characters)", 'charity-is-hope') ),
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
				...
				array(
					"param_name" => "links",
					"heading" => esc_html__("Swiper: Post's title as link", 'charity-is-hope'),
					"description" => wp_kses_data( __("Make links from post's titles", 'charity-is-hope') ),
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					...
					"class" => "",
					"value" => array(esc_html__('Titles as a links', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
				),
				array(
					"param_name" => "crop",
					"heading" => esc_html__("Swiper: Crop images", 'charity-is-hope'),
					"description" => wp_kses_data( __("Crop images in each slide or live it unchanged", 'charity-is-hope') ),
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					...
					"class" => "",
					"value" => array(esc_html__('Crop images', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
				),
				array(
					"param_name" => "autoheight",
					"heading" => esc_html__("Swiper: Autoheight", 'charity-is-hope'),
					"description" => wp_kses_data( __("Change whole slider's height (make it equal current slide's height)", 'charity-is-hope') ),
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
					...
					"class" => "",
					"value" => array(esc_html__('Autoheight', 'charity-is-hope') => 'yes'),
					"type" => "checkbox"
				),
				array(
					"param_name" => "slides_per_view",
					"heading" => esc_html__("Swiper: Slides per view", 'charity-is-hope'),
					"description" => wp_kses_data( __("Slides per view showed in this slider", 'charity-is-hope') ),
					"admin_label" => true,
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
				...
				array(
					...
					"heading" => esc_html__("Swiper: Space between slides", 'charity-is-hope'),
					"description" => wp_kses_data( __("Size of space (in px) between slides", 'charity-is-hope') ),
					"admin_label" => true,
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
				...
				array(
					"param_name" => "interval",
					"heading" => esc_html__("Swiper: Slides change interval", 'charity-is-hope'),
					"description" => wp_kses_data( __("Slides change interval (in milliseconds: 1000ms = 1s)", 'charity-is-hope') ),
					"group" => esc_html__('Details', 'charity-is-hope'),
					'dependency' => array(
						'element' => 'engine',
						'value' => array('swiper')
		...
		vc_map( array(
			...
			"name" => esc_html__("Slide", 'charity-is-hope'),
			"description" => wp_kses_data( __("Slider item - single slide", 'charity-is-hope') ),
			"show_settings_on_create" => true,
			"content_element" => true,
			"is_container" => false,
			...
			"params" => array(
				array(
					"param_name" => "src",
					"heading" => esc_html__("URL (source) for image file", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select or upload image or write URL from other site for the current slide", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "attach_image"
