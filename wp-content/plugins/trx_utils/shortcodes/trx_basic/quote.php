...
if ( !function_exists( 'charity_is_hope_sc_quote_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_quote_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_quote", array(
			"title" => esc_html__("Quote", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Quote text", 'charity-is-hope') ),
			"decorate" => false,
			"container" => true,
			"params" => array(
				"cite" => array(
					"title" => esc_html__("Quote cite", 'charity-is-hope'),
					"desc" => wp_kses_data( __("URL for quote cite", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"title" => array(
					"title" => esc_html__("Title (author)", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Quote title (author name)", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"_content_" => array(
					"title" => esc_html__("Quote content", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Quote content", 'charity-is-hope') ),
					"rows" => 4,
					"value" => "",
					"type" => "textarea"
				),
...
if ( !function_exists( 'charity_is_hope_sc_quote_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_quote_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_quote",
			"name" => esc_html__("Quote", 'charity-is-hope'),
			"description" => wp_kses_data( __("Quote text", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "cite",
					"heading" => esc_html__("Quote cite", 'charity-is-hope'),
					"description" => wp_kses_data( __("URL for the quote cite link", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					"param_name" => "title",
					"heading" => esc_html__("Title (author)", 'charity-is-hope'),
					"description" => wp_kses_data( __("Quote title (author name)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "content",
					"heading" => esc_html__("Quote content", 'charity-is-hope'),
					"description" => wp_kses_data( __("Quote content", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "textarea_html"
				),
