...
if ( !function_exists( 'charity_is_hope_sc_list_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_list_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_list", array(
			"title" => esc_html__("List", 'charity-is-hope'),
			"desc" => wp_kses_data( __("List items with specific bullets", 'charity-is-hope') ),
			"decorate" => true,
			"container" => false,
			"params" => array(
				"style" => array(
					"title" => esc_html__("Bullet's style", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Bullet's style for each list item", 'charity-is-hope') ),
					"value" => "ul",
					"type" => "checklist",
				...
				"color" => array(
					...
					"desc" => wp_kses_data( __("List items color", 'charity-is-hope') ),
					"value" => "",
					"type" => "color"
				),
				"icon" => array(
					"title" => esc_html__('List icon',  'charity-is-hope'),
					"desc" => wp_kses_data( __("Select list icon from Fontello icons set (only for style=Iconed)",  'charity-is-hope') ),
					"dependency" => array(
						'style' => array('iconed')
					),
					"value" => "",
				...
				"icon_color" => array(
					"title" => esc_html__("Icon color", 'charity-is-hope'),
					"desc" => wp_kses_data( __("List icons color", 'charity-is-hope') ),
					"value" => "",
					"dependency" => array(
						'style' => array('iconed')
					),
			...
			"children" => array(
				...
				"desc" => wp_kses_data( __("List item with specific bullet", 'charity-is-hope') ),
				"decorate" => false,
				"container" => true,
				"params" => array(
					"_content_" => array(
						"title" => esc_html__("List item content", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Current list item content", 'charity-is-hope') ),
						"rows" => 4,
						"value" => "",
						"type" => "textarea"
					),
					"title" => array(
						"title" => esc_html__("List item title", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Current list item title (show it as tooltip)", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"color" => array(
						"title" => esc_html__("Color", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Text color for this item", 'charity-is-hope') ),
						"value" => "",
						"type" => "color"
					),
					"icon" => array(
						"title" => esc_html__('List icon',  'charity-is-hope'),
						"desc" => wp_kses_data( __("Select list item icon from Fontello icons set (only for style=Iconed)",  'charity-is-hope') ),
						"value" => "",
						"type" => "icons",
						"options" => charity_is_hope_get_sc_param('icons')
					),
					"icon_color" => array(
						"title" => esc_html__("Icon color", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Icon color for this item", 'charity-is-hope') ),
						"value" => "",
						"type" => "color"
					),
					"link" => array(
						"title" => esc_html__("Link URL", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Link URL for the current list item", 'charity-is-hope') ),
						"divider" => true,
						"value" => "",
						"type" => "text"
					),
					"target" => array(
						...
						"desc" => wp_kses_data( __("Link target for the current list item", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"id" => charity_is_hope_get_sc_param('id'),
...
if ( !function_exists( 'charity_is_hope_sc_list_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_list_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_list",
			"name" => esc_html__("List", 'charity-is-hope'),
			"description" => wp_kses_data( __("List items with specific bullets", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "style",
					"heading" => esc_html__("Bullet's style", 'charity-is-hope'),
					"description" => wp_kses_data( __("Bullet's style for each list item", 'charity-is-hope') ),
					"class" => "",
					"admin_label" => true,
				...
				array(
					...
					"description" => wp_kses_data( __("List items color", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					"param_name" => "icon",
					"heading" => esc_html__("List icon", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select list icon from Fontello icons set (only for style=Iconed)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					'dependency' => array(
						'element' => 'style',
				...
				array(
					...
					"heading" => esc_html__("Icon color", 'charity-is-hope'),
					"description" => wp_kses_data( __("List icons color", 'charity-is-hope') ),
					"class" => "",
					'dependency' => array(
						'element' => 'style',
						'value' => array('iconed')
		...
		vc_map( array(
			"base" => "trx_list_item",
			"name" => esc_html__("List item", 'charity-is-hope'),
			"description" => wp_kses_data( __("List item with specific bullet", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "title",
					"heading" => esc_html__("List item title", 'charity-is-hope'),
					"description" => wp_kses_data( __("Title for the current list item (show it as tooltip)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses_data( __("Link URL for the current list item", 'charity-is-hope') ),
					"admin_label" => true,
				...
				array(
					...
					"description" => wp_kses_data( __("Link target for the current list item", 'charity-is-hope') ),
					"admin_label" => true,
					"group" => esc_html__('Link', 'charity-is-hope'),
					"class" => "",
					"value" => "",
				...
				array(
					"param_name" => "color",
					"heading" => esc_html__("Color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Text color for this item", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					"param_name" => "icon",
					"heading" => esc_html__("List item icon", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select list item icon from Fontello icons set (only for style=Iconed)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => charity_is_hope_get_sc_param('icons'),
					"type" => "dropdown"
				...
				array(
					"param_name" => "icon_color",
					"heading" => esc_html__("Icon color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Icon color for this item", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
