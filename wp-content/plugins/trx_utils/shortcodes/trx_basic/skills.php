...
if (!function_exists('charity_is_hope_sc_skills')) {	
	function charity_is_hope_sc_skills($atts, $content=null){	
		...
		extract(charity_is_hope_html_decode(shortcode_atts(array(
			...
			"bg_color" => "",
			"border_color" => "",
			"arc_caption" => esc_html__("Skills", 'charity-is-hope'),
			"pie_compact" => "on",
			"pie_cutout" => 0,
			"title" => "",
			"subtitle" => "",
...
if ( !function_exists( 'charity_is_hope_sc_skills_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_skills_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_skills", array(
			"title" => esc_html__("Skills", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Insert skills diagramm in your page (post)", 'charity-is-hope') ),
			"decorate" => true,
			"container" => false,
			"params" => array(
				"max_value" => array(
					"title" => esc_html__("Max value", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Max value for skills items", 'charity-is-hope') ),
					"value" => 100,
					"min" => 1,
					"type" => "spinner"
				),
				"type" => array(
					"title" => esc_html__("Skills type", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select type of skills block", 'charity-is-hope') ),
					"value" => "bar",
					"type" => "checklist",
					"dir" => "horizontal",
					"options" => array(
						'bar' => esc_html__('Bar', 'charity-is-hope'),
						'pie' => esc_html__('Pie chart', 'charity-is-hope'),
						'counter' => esc_html__('Counter', 'charity-is-hope'),
						'arc' => esc_html__('Arc', 'charity-is-hope')
					)
				), 
				"layout" => array(
					"title" => esc_html__("Skills layout", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select layout of skills block", 'charity-is-hope') ),
					"dependency" => array(
					...
					"dir" => "horizontal",
					"options" => array(
						'rows' => esc_html__('Rows', 'charity-is-hope'),
						'columns' => esc_html__('Columns', 'charity-is-hope')
					)
				),
				"dir" => array(
					"title" => esc_html__("Direction", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select direction of skills block", 'charity-is-hope') ),
					"dependency" => array(
						'type' => array('counter','pie','bar')
					),
					"value" => "horizontal",
				...
				"style" => array(
					"title" => esc_html__("Counters style", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Select style of skills items (only for type=counter)", 'charity-is-hope') ),
					"dependency" => array(
						'type' => array('counter')
					),
					"value" => 1,
				...
				"color" => array(
					"title" => esc_html__("Skills items color", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Color for all skills items", 'charity-is-hope') ),
					"divider" => true,
					"value" => "",
					"type" => "color"
				),
				"bg_color" => array(
					...
					"desc" => wp_kses_data( __("Background color for all skills items (only for type=pie)", 'charity-is-hope') ),
					"dependency" => array(
						'type' => array('pie')
					),
					"value" => "",
				...
				"border_color" => array(
					...
					"desc" => wp_kses_data( __("Border color for all skills items (only for type=pie)", 'charity-is-hope') ),
					"dependency" => array(
						'type' => array('pie')
					),
					"value" => "",
				...
				"align" => array(
					"title" => esc_html__("Align skills block", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Align skills block to left or right side", 'charity-is-hope') ),
					"value" => "",
					"type" => "checklist",
					"dir" => "horizontal",
				...
				"arc_caption" => array(
					"title" => esc_html__("Arc Caption", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Arc caption - text in the center of the diagram", 'charity-is-hope') ),
					"dependency" => array(
						'type' => array('arc')
					),
					"value" => "",
				...
				"pie_compact" => array(
					"title" => esc_html__("Pie compact", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Show all skills in one diagram or as separate diagrams", 'charity-is-hope') ),
					"dependency" => array(
						'type' => array('pie')
					),
					"value" => "yes",
				...
				"pie_cutout" => array(
					"title" => esc_html__("Pie cutout", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Pie cutout (0-99). 0 - without cutout, 99 - max cutout", 'charity-is-hope') ),
					"dependency" => array(
						'type' => array('pie')
					),
					"value" => 0,
			...
			"children" => array(
				...
				"title" => esc_html__("Skill", 'charity-is-hope'),
				"desc" => wp_kses_data( __("Skills item", 'charity-is-hope') ),
				"container" => false,
				"params" => array(
					"title" => array(
						"title" => esc_html__("Title", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Current skills item title", 'charity-is-hope') ),
						"value" => "",
						"type" => "text"
					),
					"value" => array(
						"title" => esc_html__("Value", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Current skills level", 'charity-is-hope') ),
						"value" => 50,
						"min" => 0,
						"step" => 1,
						"type" => "spinner"
					...
					"color" => array(
						...
						"desc" => wp_kses_data( __("Current skills item color", 'charity-is-hope') ),
						"value" => "",
						"type" => "color"
					),
					"bg_color" => array(
						"title" => esc_html__("Background color", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Current skills item background color (only for type=pie)", 'charity-is-hope') ),
						"value" => "",
						"type" => "color"
					),
					"border_color" => array(
						"title" => esc_html__("Border color", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Current skills item border color (only for type=pie)", 'charity-is-hope') ),
						"value" => "",
						"type" => "color"
					),
					"style" => array(
						"title" => esc_html__("Counter style", 'charity-is-hope'),
						"desc" => wp_kses_data( __("Select style for the current skills item (only for type=counter)", 'charity-is-hope') ),
						"value" => 1,
						"options" => charity_is_hope_get_list_styles(1, 4),
						"type" => "checklist"
					), 
					"icon" => array(
						"title" => esc_html__("Counter icon",  'charity-is-hope'),
						"desc" => wp_kses_data( __('Select icon from Fontello icons set, placed above counter (only for type=counter)',  'charity-is-hope') ),
						"value" => "",
						"type" => "icons",
...
if ( !function_exists( 'charity_is_hope_sc_skills_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_skills_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_skills",
			"name" => esc_html__("Skills", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert skills diagramm", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					...
					"heading" => esc_html__("Max value", 'charity-is-hope'),
					"description" => wp_kses_data( __("Max value for skills items", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "100",
					"type" => "textfield"
				...
				array(
					"param_name" => "type",
					"heading" => esc_html__("Skills type", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select type of skills block", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => array(
						esc_html__('Bar', 'charity-is-hope') => 'bar',
						esc_html__('Pie chart', 'charity-is-hope') => 'pie',
						esc_html__('Counter', 'charity-is-hope') => 'counter',
						esc_html__('Arc', 'charity-is-hope') => 'arc'
					),
					"type" => "dropdown"
				),
				array(
					"param_name" => "layout",
					"heading" => esc_html__("Skills layout", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select layout of skills block", 'charity-is-hope') ),
					"admin_label" => true,
					'dependency' => array(
						'element' => 'type',
					...
					"class" => "",
					"value" => array(
						esc_html__('Rows', 'charity-is-hope') => 'rows',
						esc_html__('Columns', 'charity-is-hope') => 'columns'
					),
					"type" => "dropdown"
				),
				array(
					"param_name" => "dir",
					"heading" => esc_html__("Direction", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select direction of skills block", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					"param_name" => "style",
					"heading" => esc_html__("Counters style", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select style of skills items (only for type=counter)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					"param_name" => "columns",
					"heading" => esc_html__("Columns count", 'charity-is-hope'),
					"description" => wp_kses_data( __("Skills columns count (required)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "color",
					"heading" => esc_html__("Color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Color for all skills items", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					...
					"description" => wp_kses_data( __("Background color for all skills items (only for type=pie)", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('pie')
					),
				...
				array(
					...
					"heading" => esc_html__("Border color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Border color for all skills items (only for type=pie)", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('pie')
					),
				...
				array(
					...
					"description" => wp_kses_data( __("Align skills block to left or right side", 'charity-is-hope') ),
					"class" => "",
				...
				array(
					...
					"heading" => esc_html__("Arc caption", 'charity-is-hope'),
					"description" => wp_kses_data( __("Arc caption - text in the center of the diagram", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('arc')
					),
				...
				array(
					...
					"heading" => esc_html__("Pie compact", 'charity-is-hope'),
					"description" => wp_kses_data( __("Show all skills in one diagram or as separate diagrams", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('pie')
					),
					"class" => "",
					"value" => array(esc_html__('Show separate skills', 'charity-is-hope') => 'no'),
					"type" => "checkbox"
				),
				array(
					"param_name" => "pie_cutout",
					"heading" => esc_html__("Pie cutout", 'charity-is-hope'),
					"description" => wp_kses_data( __("Pie cutout (0-99). 0 - without cutout, 99 - max cutout", 'charity-is-hope') ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('pie')
					),
		...
		vc_map( array(
			...
			"name" => esc_html__("Skill", 'charity-is-hope'),
			"description" => wp_kses_data( __("Skills item", 'charity-is-hope') ),
			"show_settings_on_create" => true,
			...
			"params" => array(
				array(
					"param_name" => "title",
					"heading" => esc_html__("Title", 'charity-is-hope'),
					"description" => wp_kses_data( __("Title for the current skills item", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "value",
					"heading" => esc_html__("Value", 'charity-is-hope'),
					"description" => wp_kses_data( __("Value for the current skills item", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "color",
					"heading" => esc_html__("Color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Color for current skills item", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				...
				array(
					"param_name" => "bg_color",
					"heading" => esc_html__("Background color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Background color for current skills item (only for type=pie)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				...
				array(
					"param_name" => "border_color",
					"heading" => esc_html__("Border color", 'charity-is-hope'),
					"description" => wp_kses_data( __("Border color for current skills item (only for type=pie)", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					"param_name" => "style",
					"heading" => esc_html__("Counter style", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select style for the current skills item (only for type=counter)", 'charity-is-hope') ),
					"admin_label" => true,
					"class" => "",
					"value" => array_flip(charity_is_hope_get_list_styles(1, 4)),
					"type" => "dropdown"
				...
				array(
					"param_name" => "icon",
					"heading" => esc_html__("Counter icon", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select icon from Fontello icons set, placed before counter (only for type=counter)", 'charity-is-hope') ),
					"class" => "",
