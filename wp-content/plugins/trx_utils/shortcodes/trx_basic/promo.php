...
if ( !function_exists( 'charity_is_hope_sc_promo_reg_shortcodes' ) ) {
	...
	function charity_is_hope_sc_promo_reg_shortcodes() {
		...
		charity_is_hope_sc_map("trx_promo", array(
			"title" => esc_html__("Promo", 'charity-is-hope'),
			"desc" => wp_kses_data( __("Insert promo diagramm in your page (post)", 'charity-is-hope') ),
			"decorate" => true,
			"container" => false,
			"params" => array(
				"align" => array(
					"title" => esc_html__("Alignment of the promo block", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Align whole promo block to left or right side of the page or parent container", 'charity-is-hope') ),
					"value" => "",
					"type" => "checklist",
					"dir" => "horizontal",
				...
				"size" => array(
					"title" => esc_html__("Size of the promo block", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Size of the promo block: large - one in the row, small - insize two or greater columns", 'charity-is-hope') ),
					"value" => "large",
					"type" => "switch",
					"options" => array(
				...
				"image" => array(
					...
					"desc" => wp_kses_data( __("Select the promo image from the library for this section", 'charity-is-hope') ),
					"readonly" => false,
					"value" => "",
					"type" => "media"
				),
				"image_position" => array(
					"title" => esc_html__("Image position", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Place the image to the left or to the right from the text block", 'charity-is-hope') ),
					"value" => "left",
					"type" => "checklist",
					"dir" => "horizontal",
				...
				"image_width" => array(
					"title" => esc_html__("Image width", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Width (in pixels or percents) of the block with image", 'charity-is-hope') ),
					"value" => "50%",
					"type" => "text"
				),
				"text_margins" => array(
					"title" => esc_html__("Text margins", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Margins for the all sides of the text block (Example: 30px 10px 40px 30px = top right botton left OR 30px = equal for all sides)", 'charity-is-hope') ),
					"value" => "",
					"type" => "text"
				),
				"text_align" => array(
					"title" => esc_html__("Text alignment", 'charity-is-hope'),
					"desc" => wp_kses_data( __("Align the text inside the block", 'charity-is-hope') ),
					"value" => "left",
					"type" => "checklist",
					"dir" => "horizontal",
...
if ( !function_exists( 'charity_is_hope_sc_promo_reg_shortcodes_vc' ) ) {
	...
	function charity_is_hope_sc_promo_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_promo",
			"name" => esc_html__("Promo", 'charity-is-hope'),
			"description" => wp_kses_data( __("Insert promo block", 'charity-is-hope') ),
			...
			"params" => array(
				array(
					"param_name" => "align",
					"heading" => esc_html__("Alignment of the promo block", 'charity-is-hope'),
					"description" => wp_kses_data( __("Align whole promo block to left or right side of the page or parent container", 'charity-is-hope') ),
					"class" => "",
					"std" => 'none',
				...
				array(
					"param_name" => "size",
					"heading" => esc_html__("Size of the promo block", 'charity-is-hope'),
					"description" => wp_kses_data( __("Size of the promo block: large - one in the row, small - insize two or greater columns", 'charity-is-hope') ),
					"class" => "",
					"value" => array(esc_html__('Use small block', 'charity-is-hope') => 'small'),
					"type" => "checkbox"
				),
				array(
					"param_name" => "image",
					"heading" => esc_html__("Image URL", 'charity-is-hope'),
					"description" => wp_kses_data( __("Select the promo image from the library for this section", 'charity-is-hope') ),
					"class" => "",
					"value" => "",
					"type" => "attach_image"
				),
				array(
					...
					"heading" => esc_html__("Image position", 'charity-is-hope'),
					"description" => wp_kses_data( __("Place the image to the left or to the right from the text block", 'charity-is-hope') ),
					"class" => "",
					"std" => 'left',
				...
				array(
					...
					"heading" => esc_html__("Image width", 'charity-is-hope'),
					"description" => wp_kses_data( __("Width (in pixels or percents) of the block with image", 'charity-is-hope') ),
					"value" => '',
					"std" => "50%",
					"type" => "textfield"
				),
				array(
					...
					"heading" => esc_html__("Text margins", 'charity-is-hope'),
					"description" => wp_kses_data( __("Margins for the all sides of the text block (Example: 30px 10px 40px 30px = top right botton left OR 30px = equal for all sides)", 'charity-is-hope') ),
					"value" => '',
					"type" => "textfield"
				),
				array(
					"param_name" => "text_align",
					"heading" => esc_html__("Text alignment", 'charity-is-hope'),
					"description" => wp_kses_data( __("Align text to the left or to the right side inside the block", 'charity-is-hope') ),
					"class" => "",
					"std" => 'left',
